...
N/*EOF*/
L 14 "../src/I2C.c" 2
N#define MDR_STT			0x2000
N#define MDR_TRX			0x0200
N#define MDR_MST			0x0400
N#define MDR_IRS			0x0020
N#define MDR_FREE		0x4000
N#define STR_XRDY		0x0010
N#define STR_RRDY		0x0008
N#define MDR_STP 		0x0800
N/*--------------------------------------------------------------------------**
N** 	Function Nmae : i2c_write_reg                                           **
N** 	Description : 	- The  function write the command and data through the  **
N** 					  I2C module                                            **
N** 	Parameters	:	- cmd - In - The cmd to be send through I2C-8bit        **
N** 					- data - In - The data to  be send through I2C-8bit     **
N** 	Rteurn : None                                                           **
N**--------------------------------------------------------------------------*/
N
Nvoid i2c_write_reg(Uint8 cmd, Uint8* data)
...
N{
N    Uint16 response =0, j;
X    unsigned short response =0, j;
N
N
N	
N	// I2C data count reg 1) RegAddr 2  data 
N	*(ioport volatile int *)0x1A14 = 0x0002;
N
N	// I2C IMR - disable all interrupts 
N	*(ioport volatile int *)0x1A04 = 0x0000;
N
N	
N	CSL_FINS(CSL_I2C_0_REGS->ICMDR,I2C_ICMDR_MST,1); /*Set as Master*/
X	((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) & ~(0x0400u)) | (((1) << (0x000Au)) & (0x0400u)));  
N    CSL_FINS(CSL_I2C_0_REGS->ICMDR,I2C_ICMDR_STT,1); /* Set the Start Condition*/
X    ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) & ~(0x2000u)) | (((1) << (0x000Du)) & (0x2000u)));  
N
N     
N    if(CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_NACK)) {
X    if((((((CSL_I2cRegsOvly) 0x1A00)->ICSTR) & (0x0002u)) >> (0x0001u))) {
N       while(1);
N    }
N
N
N	/*Check if Transmit Data Register is Ready */
N    do	{
N      response=CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_ICXRDY);
X      response=(((((CSL_I2cRegsOvly) 0x1A00)->ICSTR) & (0x0010u)) >> (0x0004u));
N    }while((response & 0x01)==0);
N	 
N
N    
N	/*Write data Transmit Data Register - Reg Address*/
N    CSL_FINS(CSL_I2C_0_REGS->ICDXR,I2C_ICDXR_D,(cmd & 0xff));
X    ((((CSL_I2cRegsOvly) 0x1A00)->ICDXR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICDXR) & ~(0x00FFu)) | ((((cmd & 0xff)) << (0x0000u)) & (0x00FFu)));
N    
N
N      
N    if(CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_NACK)) {
...
N	 
N
N	/*Write data Transmit Data Register - Reg Data1*/
N    CSL_FINS(CSL_I2C_0_REGS->ICDXR,I2C_ICDXR_D,(*(data+0) & 0xff));
X    ((((CSL_I2cRegsOvly) 0x1A00)->ICDXR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICDXR) & ~(0x00FFu)) | ((((*(data+0) & 0xff)) << (0x0000u)) & (0x00FFu)));
N    
N
N     
N    if(CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_NACK)) {
...
N
N
N	/*Stop the Transmission from I2C*/
N	CSL_FINS(CSL_I2C_0_REGS->ICMDR,I2C_ICMDR_STP,1);
X	((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) & ~(0x0800u)) | (((1) << (0x000Bu)) & (0x0800u)));
N
N 
N}
N
N
N/*------------------------------------------------------------------------------------**
N** 	FunctionName: i2c_read_reg                                                        **
N** 	Description : 	- The  function reads the command and data through the I2C module **
N** 	Parameters	:	- cmd - In - The cmd to be send through I2C                       **
N** 					- data - Out - The data to  read through I2C                      **
N** 	Return : None                                                                     **
N**------------------------------------------------------------------------------------*/
Nvoid i2c_read_reg(Uint8 cmd, Uint8* data)
...
X    unsigned short response =0, j;
N
N	// I2C data count-0  reg 1) RegAddr 2  data 
N	*(ioport volatile int *)0x1A14 = 0x0001;
N
N
N	*(ioport volatile int *)0x1A24 = 0x22A0;
N
N
N	CSL_FINS(CSL_I2C_0_REGS->ICMDR,I2C_ICMDR_MST,1); // set as Master
X	((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) & ~(0x0400u)) | (((1) << (0x000Au)) & (0x0400u))); 
N    CSL_FINS(CSL_I2C_0_REGS->ICMDR,I2C_ICMDR_STT,1); // set a Start Condition
X    ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) = ((((CSL_I2cRegsOvly) 0x1A00)->ICMDR) & ~(0x2000u)) | (((1) << (0x000Du)) & (0x2000u))); 
N
N
N  
...
N	for(j=0;j<1000;j++);
N	
N  	/* Set in Receive mode*/
N	*(ioport volatile int *)0x1A24 = 0x04A0;
N
N	/*Set the start bit*/
N	*(ioport volatile int *)0x1A24 = 0xA4A0;
N
N	/*Check for NACK */       
N    for(j=0;j<1000;j++);
N    
...
N    }
N
N	   /*Check if Receive Data Register is Ready */
N    do	{
N      response=CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_ICRRDY);
X      response=(((((CSL_I2cRegsOvly) 0x1A00)->ICSTR) & (0x0008u)) >> (0x0003u));
N    }while((response & 0x01)==0);
N
N    /* Receive 1 byte of data sent by the SLAVE*/
N	*data = CSL_FEXT(CSL_I2C_0_REGS->ICDRR,I2C_ICDRR_D);
X	*data = (((((CSL_I2cRegsOvly) 0x1A00)->ICDRR) & (0x00FFu)) >> (0x0000u));
N
N     
N    if(CSL_FEXT(CSL_I2C_0_REGS->ICSTR,I2C_ICSTR_NACK)) {
X    if((((((CSL_I2cRegsOvly) 0x1A00)->ICSTR) & (0x0002u)) >> (0x0001u))) {
...
N    }
N
N /* Set in Tx mode // Set back ACK enable*/
N	*(ioport volatile int *)0x1A24 = 0xA6A0;
N
N	
N	/* Stop I2C tx*/
N	*(ioport volatile int *)0x1A24 = 0x2EA0;
N	  
N}
N
N
NInt32 i2c_timeout = 0x0fff;
Xint i2c_timeout = 0x0fff;
N
N/* ------------------------------------------------------------------------ *
N *                                                                          *
N *  _I2C_init( )                                                            *
N *                                                                          *
N *      Enable and initalize the I2C module                                 *
N *      The I2C clk is set to run at 20 KHz                                 *
N *                                                                          *
N * ------------------------------------------------------------------------ */
NInt16 EVM5515_I2C_init( )
Xshort EVM5515_I2C_init( )
N{
N    I2C_MDR = 0x0400;             // Reset I2C
X    *(volatile ioport unsigned short*)(0x1A24) = 0x0400;             
N    I2C_PSC   = 15;               // Config prescaler for 100MHz
X    *(volatile ioport unsigned short*)(0x1A30)   = 15;               
N    I2C_CLKL  = 25;               // Config clk LOW for 100kHz
X    *(volatile ioport unsigned short*)(0x1A0C)  = 25;               
N    I2C_CLKH  = 25;               // Config clk HIGH for 100kHz
X    *(volatile ioport unsigned short*)(0x1A10)  = 25;               
N
N    I2C_MDR   = 0x0420   ;        // Release from reset; Master, Transmitter, 7-bit address
X    *(volatile ioport unsigned short*)(0x1A24)   = 0x0420   ;        
N
N    return 0;
N}
N
...
N *                                                                          *
N * ------------------------------------------------------------------------ */
NInt16 EVM5515_I2C_close( )
Xshort EVM5515_I2C_close( )
N{
N    I2C_MDR = 0;                      // Reset I2C
X    *(volatile ioport unsigned short*)(0x1A24) = 0;                      
N    return 0;
N}
N
N/* ------------------------------------------------------------------------ *
...
N *                                                                          *
N * ------------------------------------------------------------------------ */
NInt16 EVM5515_I2C_reset( )
Xshort EVM5515_I2C_reset( )
N{
N    EVM5515_I2C_close( );
N    EVM5515_I2C_init( );
N    return 0;
...
N/* ------------------------------------------------------------------------ *
N *                                                                          *
N *  _I2C_write( i2c_addr, data, len )                                       *
N *                                                                          *
N *      I2C write in Master mode                                            *
N *                                                                          *
N *      i2c_addr    <- I2C slave address                                    *
N *      data        <- I2C data ptr                                         *
N *      len         <- # of bytes to write                                  *
N *                                                                          *
N * ------------------------------------------------------------------------ */
NInt16 EVM5515_I2C_write( Uint16 i2c_addr, Uint8* data, Uint16 len )
...
N
N		//I2C_IER = 0x0000;
N        I2C_CNT = len;                    // Set length
X        *(volatile ioport unsigned short*)(0x1A14) = len;                    
N        I2C_SAR = i2c_addr;               // Set I2C slave address
X        *(volatile ioport unsigned short*)(0x1A1C) = i2c_addr;               
N        I2C_MDR = MDR_STT                 // Set for Master Write
X        *(volatile ioport unsigned short*)(0x1A24) = 0x2000                 
N                  | MDR_TRX
X                  | 0x0200
N                  | MDR_MST
X                  | 0x0400
...
X                  | 0x4000;
N
N        EVM5515_wait(100);              // Short delay
N
N        for ( i = 0 ; i < len ; i++ )
N        {
N           I2C_DXR = data[i];            // Write
X           *(volatile ioport unsigned short*)(0x1A20) = data[i];            
N            timeout = 0x7fff;//i2c_timeout;
N            do
N            {
N                if ( timeout-- < 0  )
N                {
...
N                    return -1;
N                }
N            } while ( ( I2C_STR & STR_XRDY ) == 0 );// Wait for Tx Ready
X            } while ( ( *(volatile ioport unsigned short*)(0x1A08) & 0x0010 ) == 0 );
N        }
N
N        I2C_MDR |= MDR_STP;             // Generate STOP
X        *(volatile ioport unsigned short*)(0x1A24) |= 0x0800;             
N
N		EVM5515_waitusec(1000);
N
N        return 0;
N
N}
...
N/* ------------------------------------------------------------------------ *
N *                                                                          *
N *  _I2C_read( i2c_addr, data, len )                                        *
N *                                                                          *
N *      I2C read in Master mode                                             *
N *                                                                          *
N *      i2c_addr    <- I2C slave address                                    *
N *      data        <- I2C data ptr                                         *
N *      len         <- # of bytes to write                                  *
...
N    I2C_SAR = i2c_addr;               // Set I2C slave address
X    *(volatile ioport unsigned short*)(0x1A1C) = i2c_addr;               
N    I2C_MDR = MDR_STT                 // Set for Master Read
X    *(volatile ioport unsigned short*)(0x1A24) = 0x2000                 
N              | MDR_MST
X              | 0x0400
N              | MDR_IRS
...
X              | 0x4000;
N
N    EVM5515_wait( 10 );            // Short delay
N
N    for ( i = 0 ; i < len ; i++ )
N    {
N        timeout = i2c_timeout;
N
N        //Wait for Rx Ready
N        do
N        {
...
N                return -1;
N            }
N        } while ( ( I2C_STR & STR_RRDY ) == 0 );// Wait for Rx Ready
X        } while ( ( *(volatile ioport unsigned short*)(0x1A08) & 0x0008 ) == 0 );
N
N        data[i] = I2C_DRR;            // Read
X        data[i] = *(volatile ioport unsigned short*)(0x1A18);            
N    }
N
N    I2C_MDR |= MDR_STP;               // Generate STOP
X    *(volatile ioport unsigned short*)(0x1A24) |= 0x0800;               
N
N	EVM5515_waitusec(10);
N    return 0;
N}
N
N/*EOF*/
