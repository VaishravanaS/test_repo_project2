L 1 "../src/DiagnosticsTMS.c"
N /******************************************************************************
N**File Name			: DiagnosticsTMS.c
N**File Description	:
N**Author    		: Vuon1
N**Creation Date		: 08-Aug-2016
N**Last modified date:
N**Remarks			:
N*******************************************************************************/
N#include "DiagnosticsTMS.h"
L 1 "../inc/DiagnosticsTMS.h" 1
N /******************************************************************************
N**File Name			: DiagnosticsTMS.h
N**File Description	:
N**Author    		: Vuon1
N**Creation Date		: 08-Aug-2016
N**Last modified date:
...
N*******************************************************************************/
N
N#ifndef INC_DIAGNOSTICSTMS_H_
N#define INC_DIAGNOSTICSTMS_H_
N
Nunsigned long Diagonize_SPO2_AFE4400(void);
N
N#endif /* INC_DIAGNOSTICSTMS_H_ */
L 10 "../src/DiagnosticsTMS.c" 2
...
N
N
N/*register values to be used when diagnostics is performed*/
N
NUint32 	ADS1298RegVal_debug[28] = {
N
N		   //Write register opcode1
N			0x0041,
N			//Write register opcode2
N			0x0018,
N		   	//CONFIG1 0x0001
N			 0x0086,
N		    //CONFIG2
...
N			//LOFF_FLIP (default)
N			 0x0000,
N			//LOFF_STATP (Read only)
N		     0x0000,
N			//LOFF_STATM (Read only)
N		     0x0003,
N		   //GPIO
N			 0x0000,
N			//PACE (default)
N			 0x0000,
N			//RESP (default)
N			 0x00F2, // Resp Enabled
N			 //0x00E2,
N			//0x0072,//demodulator disabled
N			 //0x00E2,//0 degrees
N			//0x00E6,
N			 //CONFIG4
N		     0x0022,//0022 respiration modulation enabled with frequency 32kHz
N			 //0x0002,//64khz
N			 //WCT1
N		     0x000A,
N		    //WCT2
...
N
N
N/*global register for storing SPO2 AFE diagnostics */
Nextern unsigned long AFE44xx_SPO2_Data_buf[7];
N
Nunsigned long Diagonize_SPO2_AFE4400(void)
N{	unsigned int i;
N	AFE44xx_Reg_Write((unsigned char)0x00,(unsigned long)0x0004);//writing control 0(address 0) with 0x0004 to enable diagnostics
N	for (i=0;i<1000;i++)
N	wait(1600);//wait for 16ms-till diagnostics completes//calculation done wrt TMS clock(100Mhz) cycles i.e. 1600000 cycles
N	return 0;
N}
N
Nint Diagonize_ECG_ADS1298(void)
N{
N
N
...
N
N
N		 /*Register write command for 23 registers from address 01h*/
N		 wLen = 8;                        /*No. of bits per word to be transmitted*/
N	#if (NEW_PG_BOARD ==1)
S	     fLen = 28;
N	#else
...
N	     Status = LLC_SPI_WordLengthWrite(ADS1298RegVal_debug, wLen, fLen);
N	     if(Status != PSP_SOK)
X	     if(Status != (0))
N		 {
N	       return (Status);
...
N
N
W "../src/DiagnosticsTMS.c" 104 11 variable "Command" was declared but never referenced
W "../src/DiagnosticsTMS.c" 105 11 variable "comWLen" was declared but never referenced
W "../src/DiagnosticsTMS.c" 106 11 variable "comFLen" was declared but never referenced
N}
