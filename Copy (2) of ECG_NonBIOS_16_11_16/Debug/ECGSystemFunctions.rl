L 1 "../src/ECGSystemFunctions.c"
N /******************************************************************************
N**File Name			: ECGSystemFunctions.c
N**File Description	:
N**Created By		:
N**Creation Date		:
...
N
N
N#include "ECGSystemFunctions.h"
L 1 "../inc/ECGSystemFunctions.h" 1
N/******************************************************************************
N**File Name			: ECGSystemFunctions.h
N**File Description	:The file defines all the functions used in the ECGSystemFunctions.c
N**Created By		:
N**Creation Date		:
N**Last modified date:
N**Remarks			:
...
N
N
N#ifndef _ECGSYSTEMALGORITHMS_H
N#define _ECGSYSTEMALGORITHMS_H
N
N#include<stdio.h>
...
N
N
L 15 "../inc/ECGSystemFunctions.h" 2
N#include<math.h>
...
L 16 "../inc/ECGSystemFunctions.h" 2
N#include<file.h>
...
N#endif /* _FILE */
N
L 17 "../inc/ECGSystemFunctions.h" 2
N#include <stdio.h>
L 1 "C:/ti/ccsv6/tools/compiler/c5500_4.4.1/include/stdio.h" 1
N/*****************************************************************************/
N/* STDIO.H v4.4.1                                                            */
...
N
N
L 18 "../inc/ECGSystemFunctions.h" 2
N#include <std.h>
...
N
N#endif /* STD_ */
L 19 "../inc/ECGSystemFunctions.h" 2
...
N/*EOF*/
L 20 "../inc/ECGSystemFunctions.h" 2
N#include "dda_spi.h"
L 1 "..\inc\dda_spi.h" 1
N/******************************************************************************
...
N#endif /* _DDA_SPI_H_ */
N/*EOF*/
L 21 "../inc/ECGSystemFunctions.h" 2
N#include "timer.h"
L 1 "..\inc\timer.h" 1
N /******************************************************************************
N**File Name			: timer.h
...
N/*EOF*/
L 22 "../inc/ECGSystemFunctions.h" 2
N#include "llc_spi.h"
N#include "ADS1298.h"
L 1 "..\inc\ADS1298.h" 1
N/******************************************************************************
...
N#endif
N/*EOF*/
L 24 "../inc/ECGSystemFunctions.h" 2
...
N
N#endif
L 26 "../inc/ECGSystemFunctions.h" 2
N#include "corazon.h"
...
N*/
N#endif
L 27 "../inc/ECGSystemFunctions.h" 2
N#include "cslr.h"
N#include "lcd.h"
L 1 "..\inc\lcd.h" 1
N/******************************************************************************
...
N#endif
N/*EOF*/
L 29 "../inc/ECGSystemFunctions.h" 2
N#include "I2C.h"
L 1 "..\inc\I2C.h" 1
N/******************************************************************************
N**File Name			: I2C.h
...
N#endif
N/*EOF*/
L 30 "../inc/ECGSystemFunctions.h" 2
N#include "LCD_FontTable.h"
N#include "sar.h"
L 1 "..\inc\sar.h" 1
N/******************************************************************************
...
N#define SW16 0x3FB
N/*EOF*/
L 32 "../inc/ECGSystemFunctions.h" 2
...
N#endif
N/*EOF*/
L 33 "../inc/ECGSystemFunctions.h" 2
N#include "typedef.h"
L 1 "..\inc\typedef.h" 1
N/******************************************************************************
...
N
N/*EOF*/
L 34 "../inc/ECGSystemFunctions.h" 2
N
N
N
N#define LCDDECIMATOR 2
N#define UARTDECIMATOR 1
N#define BYTEMASK 0x000000FF
N		
N
N/* function to read channel data*/	 		
Nvoid ADS1258_Read_ChannelData(Uint8*,Uint8*);
N/*	function give wait cycles*/
Nvoid wait(Uint32 count);
N/* function to convert the hex values to signed int*/
Ndouble CurrInp_Voltage(Uint32);
N/* convert the 4 byte channel data to 24bit sample*/
NInt32 ECG_GetCurrAqsnSample(Uint8*);
N/* process the current sample*/
N void ECG_ProcessCurrSample(Int16 *, Int16 *);
N/* plot the current sample in LCD*/
Nvoid ECG_LCDPlotCurrSample(Int16 * , Uint16);
N/* function to get the sample from structure Lead_Info_Buffer*/
Nstatic void QRS_call_process_buffer(void);
N/*function to calculate the derivatives and fill in process buffer B4*/	
Nstatic void QRS_process_buffer(void);
N/* function to find the first maxima in a window of defined samples*/
Nstatic Uint32 QRS_maxima(void);
N/*function to calculate HR when B4 is filled with 2700 samples */
Nstatic void QRS_Heart_Rate_Calc(void);
N/* function which is called by the main thread at filling of every(N/3) */
N/* samples in Lead_Info_Buffer                                          */
Nvoid QRS_Algorithm_Interface(Int16);
N/* Return the current calculated heart rate*/
NUint16 QRS_Get_Heart_Rate( void );
NUint32 QRS_main(void);
N/* Transmission of the curret set of sample thru UART*/
Nvoid ECG_UARTTxCurrSamples(Int16 *);
N/* Transmission of the curret set of sample thru UART*/
Nvoid ECG_UARTTxCurrSamples_debug(Int16 *);
N/*Check Lead Off Status for all electrodes for every 2s*/
Nvoid QRS_LeadOffStatus_Check(void);
N
Nstatic void QRS_check_sample_crossing_threshold( Uint16 );
N#endif
N/*EOF*/
L 12 "../src/ECGSystemFunctions.c" 2
N#include "oled.h"
L 1 "../inc/oled.h" 1
N/******************************************************************************
N**File Name			:  oled.h
...
N#endif
N/*EOF*/
L 13 "../src/ECGSystemFunctions.c" 2
N#include "lcd_command.h"
L 1 "../inc/lcd_command.h" 1
N/******************************************************************************
N**File Name			: lcd_command.h
N**File Description	: Definitions LCD commands which is in the C5515 EVM
N**Created By		:
N**Creation Date		:
N**Last modified date:
N**Remarks			:
N*******************************************************************************/
N#ifndef _LCD_COMMAND_H_
N#define _LCD_COMMAND_H_
N
N
N#define DISPLAY_WIDTH           128
N#define DISPLAY_HEIGHT          128
...
N#endif
N/*EOF*/
L 14 "../src/ECGSystemFunctions.c" 2
N
N#define MAX_PEAK_TO_SEARCH 				5
N#define THREE_SEC_SAMPLES  				1500
N
N#define BUFFER_SHIFT 0
N#define ASSEMBLY_IMP 1
N
N
Nextern ECG_FilterProcess(Int16 *,Int16 *,Int16*);
N
N//#pragma DATA_SETCTION(WorkingBuff,".WorkBuffer");
N/* Working Buffer Used for Filtering*/
NInt16 WorkingBuff[MAXCHAN][2 * FILTERORDER];
XInt16 WorkingBuff[(8)][2 * (351)];
N/* System Information structure*/
Nextern ECG_System_Info ECG_Info;
N/* Multi band FIR LPF coefficients*/
Nextern Int16 CoeffBuf[];
N
N/* structure which stores the UART configuration values*/
N/* Instance no used for UART */
NUint8 instNum = 0;
N/* Handle for UART driver*/
NPSP_Handle hUart = 0;
N
N
N/*  Pointer which points to the index in B4 buffer where the processed data*/
N/*  has to be filled */
Nstatic Uint16 QRS_B4_Buffer_ptr = 0 ;
N/* Variable which will hold the calculated heart rate */
NUint16 QRS_Heart_Rate = 0 ;
N
N/* 	Variable which holds the threshold value to calculate the maxima*/
NUint16 QRS_Threshold_New = 0;
N
N/* Variables to hold the sample data for calculating the 1st and 2nd */
N/* differentiation                                                   */
N
N
NInt16 QRS_Second_Prev_Sample = 0 ;
NInt16 QRS_Prev_Sample = 0 ;
NInt16 QRS_Current_Sample = 0 ;
NInt16 QRS_Next_Sample = 0 ;
NInt16 QRS_Second_Next_Sample = 0 ;
NInt16 j = 0;
N
NInt16 cs_flag=0;
NUint8 col = 0;
N
N/*Flag which identifies the duration for which sample count has to be incremented*/
NUint8 Start_Sample_Count_Flag = 0;
NUint8 first_peak_detect = FALSE ;
XUint8 first_peak_detect = (0U) ;
NUint16 sample_count = 0 ;
NUint16 sample_index[MAX_PEAK_TO_SEARCH+2] = {0};
XUint16 sample_index[5+2] = {0};
N
N/* indicates the Zoom-in/ Zoom-out status of the waveform displayed on LCD */
NUint8 Zoom_Flag = 0;
N/* variable to hold the status of the lead to be displayed on a key-press */
NUint8 Key_Count = 0;
N/* variable to store the zooming value */
NUint16 Zoom_Factor = MEDIUM;
XUint16 Zoom_Factor = 325;
NUint16 FB[128][3];
N
N/*-------------------------------------------------------------------------**
N** Function Name 	: ECG_UARTTxCurrSamples()                              **
N** Description		: 	- The function transmits the current row () of the **
N** 					LeadInfo buffer i.e., current samples of all the       **
N** 					leads through UART At every 1 sec, the UART Packet     **
N** 					Header has to be transmitted. Also the LeadOff         **
N** 					Status and the HR value has to be transmitted The      **
N** 					Packet No is transmitted along with all the packets.   **
N** 					The Packet no has to start from 0 at every 1 sec.      **
N**                                                                         **
N** Parameters	  	: CurrLead 		- In - Current processing lead         **
N** 				    LeadInfoBufRow  - In - Currently filled row            **
N** Return			: None                                                 **
N**-------------------------------------------------------------------------*/
N
N	Uint8 LCD_pacer =0;
N	extern Uint16 Pacer_detected;
N
N
N/*-----------------------------------------------------------------------------**
N** Function Name : ECG_LCDPlotCurrSample()                                     **
N** Description	  : The function plots the current processed sample in the LCD **
N** Parameters	  : CurrLead 		- In - Current processing lead             **
N** 				    LeadInfoBufRow  - In - Currently filled row                **
N** Returns		  : void                                                       **
N**-----------------------------------------------------------------------------*/
Nvoid ECG_LCDPlotCurrSample(Int16 *CurSample, Uint16 DispLead)
N{
N
N	static Int16 row_amplitude_old = 40;
N	Int16 Amplitude = 0;
N	Int16 i, row_amplitude = 0;
N
N	Zoom_Factor = 1;
N	/* check for Zoom key_press status*/
N	if(Zoom_Flag == 1)
N	{
N		Zoom_Factor = HIGH;
X		Zoom_Factor = 160;
N	}
N	else if(Zoom_Flag == 2)
N	{
N		Zoom_Factor = LOW;
X		Zoom_Factor = 650;
N	}
...
N		/*Display Lead I*/
N					row_amplitude = 70 -
N									(((double)(CurSample[0]) /
N									Zoom_Factor) * 40);
N				break;
N		case 1:
N				/*Display Lead II*/
N				row_amplitude = 70 -
N								(((double)(CurSample[1])/
N								Zoom_Factor) * 40);
N				break;
N
N		case 2:
N				/*Display Lead III*/
N				row_amplitude = 70 -
N								(((double)(CurSample[1] - CurSample[0])/
N								Zoom_Factor) * 40);
N				break;
N
N		case 3:
N				/*Display Lead aVR*/
N				row_amplitude = 70 -
N								(((double)(-0.5 * (CurSample[1] + CurSample[0])))/
N								Zoom_Factor) * 40;
N		    	break;
N
N		case 4:
N				/*Display Lead aVL*/
N				row_amplitude = 70 -
N								(((double)CurSample[0] -(0.5 * CurSample[1]))/
N								Zoom_Factor) * 40;
N
N				break;
N
...
N				/*Display Lead aVF*/
N				row_amplitude = 70 -
N								(((double) CurSample[1] - ( 0.5 * CurSample[0]))/
N								(Zoom_Factor) * 40);
N
N				break;
N
...
N				/*Display Lead V6*/
N				row_amplitude = 70 -
N								(((double) (CurSample[7] )/
N								Zoom_Factor) * 40);
N				break;
N		default:
N				/*Default condition-Display Lead II*/
N				row_amplitude = 70 -
N								(((double)(CurSample[1])/
N								Zoom_Factor) * 40);
N			break;
N	}
N
N	/* limitting the display to the available LCD screen.*/
N	if(row_amplitude < 2)
N	{
N		row_amplitude = 2;
N	}
N	else
N	{
N		//if(row_amplitude > 106)
N		//{
N		//	row_amplitude = 106;
N		//}
N				if(row_amplitude > 100) // EVM 5515
N				{
N					row_amplitude = 100;
N				}
N	}
N
N	/* Calculating the absolute row value */
N	Amplitude = abs(row_amplitude_old - row_amplitude);
N
N            // save the position
N			FB[col][0] = Amplitude;
N			FB[col][1] = row_amplitude_old;
N			FB[col][2] = row_amplitude;
N
N
N	if(Amplitude >= 2 )
N	{
...
N	    		}			    
N#else
S		for(j = 0 ;j < (Amplitude - 1);j++)
S		{
S            cmdWrite(SET_COL_ADD);
S	        dataWrite(col);
S	        dataWrite(col);        
S            
S	        cmdWrite(SET_ROW_ADD); 
S			if(row_amplitude > row_amplitude_old)
S			{
S				dataWrite(22+(row_amplitude_old+j));
S				dataWrite(22+(row_amplitude_old+j));
S			}
S			else
S			{
...
S			}
S            
S	        cmdWrite(WRITE_COMMAND);            // Enable MCU to Write into RAM	 
S			/* glow the pixel corresponding to that row */
S			dataWrite(0);
S			dataWrite(0x3F);
S			dataWrite(0);
S		}
...
N	}
N
N	row_amplitude_old = row_amplitude;
N
N	if ( LCD_pacer )
N	{
N		cmdWrite(SET_COL_ADD);
...
N	}
N#if 1
N	        LCD_clear_window(col,23,col,27);
W "../src/ECGSystemFunctions.c" 475 13 function declared implicitly
N            lcd_remove_waveform(col,FB[col][0],FB[col][1],FB[col][2]);
N#else
S	/* Clear Window for next 10 pixels to give a scrolling appearence */
S	LCD_clear_window(col,22,col+10,128);
S//	cmdWrite(0x8E);
S//	dataWrite(col);
S//	dataWrite(22);
S//	dataWrite(col+10);
...
N#endif
N
W "../src/ECGSystemFunctions.c" 107 8 variable "i" was declared but never referenced
N}
N
N/*--------------------------------------------------------------------------**
N** Function Name : ECG_ProcessCurrSample()                                  **
N** Description	  :                                                         **
N** 				The function process one sample of data at a time and       **
N** 				which stores the filtered out sample in the Leadinfobuff.   **
N** 				The function does the following :-                          **
N**                                                                          **
N** 				- DC Removal of the current sample                          **
N** 				- Multi band FIR LPF with Notch at 50Hz filtering           **
N** Parameters	  :                                                         **
N** 				- CurrAqsSample		- In - AqsnBuf Row count                **
N** 				- FirstFlag			- In - Flag to idenftify the first exec **
N** 				- CurrFilterChan	- In - Current Row of filtering         **
N** 				- CurrLeadInfoRow	- In - Current row of lead info buff    **
N** Return 		  : None                                                    **
N**--------------------------------------------------------------------------*/
Nvoid ECG_ProcessCurrSample(Int16 *CurrAqsSample, Int16 *FilteredOut)
N{
N
N 	static Uint16 bufStart=0, bufCur = FILTERORDER-1, FirstFlag = 1;
X 	static Uint16 bufStart=0, bufCur = (351)-1, FirstFlag = 1;
N
N	/* Count variable*/
N	Uint16 Cur_Chan;
N	Int16 FiltOut;
...
N	if  ( FirstFlag )
N	{
N		for ( Cur_Chan =0 ; Cur_Chan < FILTERORDER; Cur_Chan++)
X		for ( Cur_Chan =0 ; Cur_Chan < (351); Cur_Chan++)
N		{
N			WorkingBuff[0][Cur_Chan] = 0;
N			WorkingBuff[1][Cur_Chan] = 0;
N			WorkingBuff[2][Cur_Chan] = 0;
N			WorkingBuff[3][Cur_Chan] = 0;
N			WorkingBuff[4][Cur_Chan] = 0;
N			WorkingBuff[5][Cur_Chan] = 0;
N			WorkingBuff[6][Cur_Chan] = 0;
N			WorkingBuff[7][Cur_Chan] = 0;
N		} 
N		FirstFlag = 0;
N	}
N	for (Cur_Chan = 0; Cur_Chan < 8; Cur_Chan++)
N	{
N
N		/* Store the DC removed value in Working buffer in millivolts range*/
N		WorkingBuff[Cur_Chan][bufCur] = CurrAqsSample[Cur_Chan];
N		ECG_FilterProcess(&WorkingBuff[Cur_Chan][bufCur],CoeffBuf,(Int16*)&FilterOut);
N		/* Store the DC removed value in Working buffer in millivolts range*/
N		WorkingBuff[Cur_Chan][bufStart] = CurrAqsSample[Cur_Chan];
N
N
N		FiltOut = (Int16)(((FilterOut[0] >> 15) & (0x0000FFFF)));
N
N		/* Store the filtered out sample to the LeadInfo buffer*/
N		FilteredOut[Cur_Chan] = FiltOut ;//(CurrOut);
N
N	}
N
N	bufCur++;
N	bufStart++;
N	if ( bufStart  == (FILTERORDER-1))
X	if ( bufStart  == ((351)-1))
N	{
N		bufStart=0; 
N		bufCur = FILTERORDER-1;
X		bufCur = (351)-1;
N	 }
N
N	return ;
N}
N/*-------------------------------------------------------------------------------**
N** 	Function Name : Wait()                                                       **
N** 	Description  : 	- The function gives a delay of n CPU cycles where n is the  **
N** 					  parameter Count                                            **
N** 	Parameters	:	- Count - In - no of delay cycles                            **
N** 	Return		: none                                                           **
N**-------------------------------------------------------------------------------*/
N
Nvoid wait(Uint32 count)
...
N
N/*-------------------------------------------------------------------**
N** 	Function Name : QRS_Get_Heart_Rate()                             **
N** 	Description - This function gives the HR value when called       **
N** 	Parameter -   Nil                                                **
N** 	Return - QRS_Heart_Rate                                          **
N**-------------------------------------------------------------------*/
N
NUint16 QRS_Get_Heart_Rate( )
N{
N	return ( QRS_Heart_Rate ) ;
N}
N
N
N
Nstatic void QRS_check_sample_crossing_threshold( Uint16 scaled_result )
N{
N	/* array to hold the sample indexes S1,S2,S3 etc */
N	extern Uint16 LeadOffStatus;
N	
N	static Uint16 s_array_index = 0 ;
N	static Uint16 m_array_index = 0 ;
N	
N	static Uint8 threshold_crossed = FALSE ;
X	static Uint8 threshold_crossed = (0U) ;
N	static Uint16 maxima_search = 0 ;
N	static Uint8 peak_detected = FALSE ;
X	static Uint8 peak_detected = (0U) ;
N	static Uint16 skip_window = 0 ;
N	static Uint16 peak = 0;
N	static Uint32 sample_sum = 0;
N	static Uint16 nopeak=0;
N	Uint16 HRAvg;
N
N	extern Uint8 HR_flag;
N	extern Uint8 Initial_HR_Flag;
N
N	sample_count ++ ;
N	if( TRUE == threshold_crossed  )
X	if( (1U) == threshold_crossed  )
N	{
N		/*
N		Once the sample value crosses the threshold check for the
N		maxima value till MAXIMA_SEARCH_WINDOW samples are received
N		*/
N		maxima_search ++ ;
N
N		if( scaled_result > peak )
N		{
N			peak = scaled_result ;
N		}
N
N		if( maxima_search >= MAXIMA_SEARCH_WINDOW )
X		if( maxima_search >= 40 )
N		{
N			// Store the maxima values for each peak
N			threshold_crossed = FALSE ;
X			threshold_crossed = (0U) ;
N			peak_detected = TRUE ;
X			peak_detected = (1U) ;
N		}
N
N	}
N	else if( TRUE == peak_detected )
X	else if( (1U) == peak_detected )
N	{
N		/*
N		Once the sample value goes below the threshold
N		skip the samples untill the SKIP WINDOW criteria is meet
N		*/
N		skip_window ++ ;
N
N		if( skip_window >= MINIMUM_SKIP_WINDOW )
X		if( skip_window >= 50 )
N		{
N			peak_detected = FALSE ;
X			peak_detected = (0U) ;
N		}
N
N		if( m_array_index == MAX_PEAK_TO_SEARCH )
X		if( m_array_index == 5 )
N		{
N			
N			sample_sum =  (  sample_sum / (MAX_PEAK_TO_SEARCH - 1) ) ;
X			sample_sum =  (  sample_sum / (5 - 1) ) ;
N			HRAvg = (Uint16) sample_sum;
N			if(((LeadOffStatus & 0x0007)== 0x0007)||((LeadOffStatus & 0x01FF)== ELECTRODE_LA))
X			if(((LeadOffStatus & 0x0007)== 0x0007)||((LeadOffStatus & 0x01FF)== 0x01FD))
N			{
N				
N				QRS_Heart_Rate = (Uint16) 60 *  SAMPLING_RATE / HRAvg ;
X				QRS_Heart_Rate = (Uint16) 60 *  (500) / HRAvg ;
N				if(QRS_Heart_Rate > 250)
N					QRS_Heart_Rate = 250 ;
N			}
N			else
N			{
N				QRS_Heart_Rate = 0;
N			}
N			/* Setting the Current HR value in the ECG_Info structure*/
N			ECG_Info.ECG_HeartRate = QRS_Heart_Rate;
N			HR_flag = 1;
N			Initial_HR_Flag = 1;
N			skip_window = 0 ;
N
...
N			sample_index[3] = 0 ;
N			sample_index[4] = 0 ;
N			Start_Sample_Count_Flag = 1;
N			sample_sum = 0;
N		}
N	}
N	else if( scaled_result > QRS_Threshold_New )
N	{
N		/*
N			If the sample value crosses the threshold then store the sample index
N		*/
N		Start_Sample_Count_Flag = 1;
N		m_array_index++;
N		threshold_crossed = TRUE ;
X		threshold_crossed = (1U) ;
N		peak = scaled_result ;
N		nopeak = 0;
N		maxima_search = 0 ;
N		skip_window = 0 ;
N		/*	storing sample index*/
N	   	sample_index[ s_array_index ] = sample_count ;
N		if( s_array_index >= 1 )
N		{
N			sample_sum += sample_index[ s_array_index ] - sample_index[ s_array_index - 1 ] ;
N
N		}
N		s_array_index ++ ;
N	}
N
N	else if(( scaled_result < QRS_Threshold_New ) && (Start_Sample_Count_Flag == 1))
N	{
N        nopeak++;	
N        if (nopeak > (3 * SAMPLING_RATE))
X        if (nopeak > (3 * (500)))
N        { 
N        	sample_count = 0 ;
N	 		s_array_index = 0 ;
...
N			sample_index[3] = 0 ;
N			sample_index[4] = 0 ;
N			Start_Sample_Count_Flag = 0;
N			peak_detected = FALSE ;
X			peak_detected = (0U) ;
N			sample_sum = 0;
N        	    	
N        	first_peak_detect = FALSE;
X        	first_peak_detect = (0U);
N	      	nopeak=0;
N
N			QRS_Heart_Rate = 0;
N			ECG_Info.ECG_HeartRate = QRS_Heart_Rate;
...
N
N/*-----------------------------------------------------------------------**
N** 	Function Name : QRS_process_buffer()                                 **
N** 	Description -                                                        **
N** 	                                                                     **
N** 					This function will be doing the first and second     **
N** 					order differentiation for 	input sample,            **
N** 					QRS_Current_Sample.After we process the data we can  **
N** 					fill the 	QRS_Proc_Data_Buffer which is the input  **
N** 					for HR calculation Algorithm. This function is       **
N** 					called for each n sample.Once we have received 6s of **
N** 					processed 	data(i.e.Sampling rate*6) in the B4      **
N** 					buffer we will start the heart rate calculation for  **
N** 					first time and later we will do heart rate           **
N** 					calculations once we receive the defined 	number   **
N** 					of samples for the expected number of refresh        **
N** 					seconds.                                             **
N** 	                                                                     **
N** 	Parameters  - Nil                                                    **
N** 	Return 		- None                                                   **
...
N
N	extern Uint16 LeadOffStatus;
N	Int16 first_derivative = 0 ;
N	Uint16 scaled_result = 0 ;
N
N	static Uint16 max = 0;
N
N	/* calculating first derivative*/
N	first_derivative = QRS_Next_Sample - QRS_Prev_Sample  ;
N
N	/*taking the absolute value*/
N
N	if(first_derivative < 0)
N	{
N		first_derivative = -(first_derivative);
N	}
N
N	scaled_result = first_derivative;
N
N	if( scaled_result > max )
N	{
N		max = scaled_result ;
N	}
N
N	QRS_B4_Buffer_ptr++;
N	if (QRS_B4_Buffer_ptr ==  THREE_SEC_SAMPLES)
X	if (QRS_B4_Buffer_ptr ==  1500)
N	{
N		QRS_Threshold_New = (Uint16)( QRS_THRESHOLD_FRACTION * max ) ;
X		QRS_Threshold_New = (Uint16)( 0.7 * max ) ;
N		if(max > 10)
N		first_peak_detect = TRUE ;
X		first_peak_detect = (1U) ;
N		QRS_B4_Buffer_ptr = 0;
N		max = 0;
N	}
N
N
N	if( TRUE == first_peak_detect )
X	if( (1U) == first_peak_detect )
N	{
N		QRS_check_sample_crossing_threshold( scaled_result ) ;
N	}
N}
N
N/*-----------------------------------------------------------------------**
N**                                                                       **
N** 	Function Name : QRS_Algorithm_Interface                              **
N** 	Description -   This function is called by the main acquisition      **
N** 					thread when (N/3) samples are filled in				 **
N** 					the Lead_Info_buffer for Lead II.Here N = 351 and    **
N** 					thus it is called for a fill of every 117			 **
N** 					samples												 **
N**                  Before calling the process_buffer() the below check  **
N** 					has to be done. i.e. We have always received +2      **
N** 					samples before starting the processing  for each     **
N** 					samples. This function basically checks the          **
N** 					difference between the QRS_Lead_Process_Ptr and      **
N** 					Main_Index_Ptr and picks the data from               **
N** 					Lead_Info_Buffer for processing.  This function also **
N** 					checks for the roll back and fill the variables      **
N** 					accordingly which will be used in the 1st and 2nd    **
N** 					differentiation calculations.                        **
N**                                                                       **
N** 	Parameters  : - data - array having eight channel read data          **
N** 	Return		: None                                                   **
N**-----------------------------------------------------------------------*/
Nvoid QRS_Algorithm_Interface(Int16 CurrSample)
N{
N
N	static short prev_data[32] ={0};
N	short i;
N	Int32 Mac=0;
N	prev_data[0] = CurrSample;
N	for ( i=31; i > 0; i--)
N	{
N		Mac += prev_data[i];
N		prev_data[i] = prev_data[i-1];
N
N	}
N	Mac += CurrSample;
N	Mac = Mac >> 2;
N	CurrSample = (short) Mac;
N	QRS_Second_Prev_Sample = QRS_Prev_Sample ;
N	QRS_Prev_Sample = QRS_Current_Sample ;
N	QRS_Current_Sample = QRS_Next_Sample ;
N	QRS_Next_Sample = QRS_Second_Next_Sample ;
N	QRS_Second_Next_Sample = CurrSample ;
N
N	QRS_process_buffer();
N}
N
N/*EOF*/
N
