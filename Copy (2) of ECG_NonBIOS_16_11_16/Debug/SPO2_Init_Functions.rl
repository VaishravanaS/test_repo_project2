L 1 "../src/SPO2_Init_Functions.c"
N/******************************************************************************
N**File Name			: SPO2_Functions.c
N**File Description	:
N**Created By		:Vuon1
N**Creation Date		:07-Jul-2016
...
N/*EOF*/
L 10 "../src/SPO2_Init_Functions.c" 2
N//#include "evm5515.h"
N#include "llc_spi.h"
L 1 "../inc/llc_spi.h" 1
N/******************************************************************************
...
N
N/*EOF*/
L 12 "../src/SPO2_Init_Functions.c" 2
N#include "corazon.h"
...
N*/
N#endif
L 13 "../src/SPO2_Init_Functions.c" 2
N
N#define DELAY_COUNT 2
Nunsigned long 	AFE44xx_Default_Register_Settings[49] = {
N	//Reg0: CONTROL0: CONTROL REGISTER 0
N	0x00000,
N   	//Reg1:REDSTARTCOUNT: SAMPLE RED START COUNT
N	//6000,
N	48000,
N
N        //Reg2:REDENDCOUNT: SAMPLE RED END COUNT
N	//7599,
N	60792,
N        //Reg3:REDLEDSTARTCOUNT: RED LED START COUNT
N	//6000,
N	48000,
N        //Reg4:REDLEDENDCOUNT: RED LED END COUNT
N	//7599,
N	60792,
N	//Reg5:AMBREDSTARTCOUNT: SAMPLE AMBIENT RED START COUNT
N	0000,
N	//Reg6:AMBREDENDCOUNT: SAMPLE AMBIENT RED END COUNT
N	//1599,
N	12792,
N	//Reg7:IRSTARTCOUNT: SAMPLE IR START COUNT
N	//2000,
N	16000,
N        //Reg8:IRENDCOUNT: SAMPLE IR END COUNT
N	//3599,
N	28792,
N        //Reg9:IRLEDSTARTCOUNT: IR LED START COUNT
N	//2000,
N	16000,
N	//Reg10:IRLEDENDCOUNT: IR LED END COUNT
N	//3599,
N	28792,
N	//Reg11:AMBIRSTARTCOUNT: SAMPLE AMBIENT IR START COUNT
N	//4000,
N	32000,
N        //Reg12:AMBIRENDCOUNT: SAMPLE AMBIENT IR END COUNT
N	//5599,
N	44792,
N	//Reg13:REDCONVSTART: REDCONVST
N	//2,
N	16,
N	//Reg14:REDCONVEND: RED CONVERT END COUNT
N	//1999,
N	15992,
N	//Reg15:AMBREDCONVSTART: RED AMBIENT CONVERT START COUNT
N	//2002,
N	16016,
N	//Reg16:AMBREDCONVEND: RED AMBIENT CONVERT END COUNT
N	//3999,
N	31992,
N	//Reg17:IRCONVSTART: IR CONVERT START COUNT
N	//4002,
N	32016,
N	//Reg18:IRCONVEND: IR CONVERT END COUNT
N	//5999,
N	47992,
N	//Reg19:AMBIRCONVSTART: IR AMBIENT CONVERT START COUNT
N	//6002,
N	48016,
N	//Reg20:AMBIRCONVEND: IR AMBIENT CONVERT END COUNT
N	//7999,
N	63992,
N	//Reg21:ADCRESETSTCOUNT0: ADC RESET 0 START COUNT
N	0,
N	//Reg22:ADCRESETENDCOUNT0: ADC RESET 0 END COUNT
N	0,
N	//Reg23:ADCRESETSTCOUNT1: ADC RESET 1 START COUNT
N	//2000,
N	16000,
N	//Reg24:ADCRESETENDCOUNT1: ADC RESET 1 END COUNT
N	//2000,
N	16000,
N	//Reg25:ADCRESETENDCOUNT2: ADC RESET 2 START COUNT
N	//4000,
N	32000,
N	//Reg26:ADCRESETENDCOUNT2: ADC RESET 2 END COUNT
N	//4000,
N	32000,
N	//Reg27:ADCRESETENDCOUNT3: ADC RESET 3 START COUNT
N	//6000,
N	48000,
N	//Reg28:ADCRESETENDCOUNT3: ADC RESET 3 END COUNT
N	//6000,
N	48000,
N	//Reg29:PRPCOUNT: PULSE REPETITION PERIOD COUNT
N	//7999,
N	63992,
N	//Reg30:CONTROL1: CONTROL REGISTER 1
N	0x00107,  //timer enabled, averages=3, RED and IR LED pulse ON PD_ALM AND LED_ALM pins
N	//Reg31:?: ??
N	0x00000,
N	//Reg32:TIAGAIN: TRANS IMPEDANCE AMPLIFIER GAIN SETTING REGISTER
N	0x00000,
N	//Reg33:TIA_AMB_GAIN: TRANS IMPEDANCE AAMPLIFIER AND AMBIENT CANELLATION STAGE GAIN
N	//0x0000,
N	//0x04400,//gain 4
N	0x0006,
N	 //Reg34:LEDCNTRL: LED CONTROL REGISTER
N	//0x11414,//default 3.9mA
N	//0x19696,//30mA
N	//0x11A1A,//5mA
N	//0x16464,//19.5mA
N	0x14B4B,//14.64mA
N
N	//Reg35:CONTROL2: CONTROL REGISTER 2
N	0x00000, //bit 9
N	//Reg36:?: ??
N	0x00000,
N	//Reg37:?: ??
...
N	//Reg41:ALARM: ??
N	0x00000,
N	//Reg42:REDVALUE: RED DIGITAL SAMPLE VALUE
N	0x00000,
N	//Reg43:AMBREDVALUE: Ambient RED Digital Sample Value
N	0x00000,
N	//Reg44:IRVALUE: IR Digital Sample Value
N	0x00000,
N	//Reg45:AMBIRVALUE: Ambient IR Digital Sample Value
N	0x00000,
N	//Reg46:RED-AMBREDVALUE: RED-AMBIENT RED DIGITAL SAMPLE VALUE
N	0x00000,
N	//Reg47:IR-AMBIRVALUE: IR-AMBIENT IR DIGITAL SAMPLE VALUE
N	0x00000,
N	 //Reg48:DIGNOSTICS: DIAGNOSTICS FLAGS REGISTER
N	0x00000
N};
N
N
...
N{
N
N	unsigned long SPI_Rx_buf[5];
N	unsigned int dummy;
N	int i,result;
N	Uint16 sts;
N    Uint16 wordComplete;
N    Uint16 spiBusStatus;
N
N	//send 0x0001 to read AFE4400
N    //send 1st byte i.e address of control 0 register
N	CSL_SPI_REGS->SPIDR2 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0000;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 165 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 173 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 181 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N	//send 4th byte
N	CSL_SPI_REGS->SPIDR2 = 0x0100;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0100;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 190 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
N	LLC_SPI_StatusRead(&sts);
N	}while(((sts & 0x02) != 0x01) && ((sts & 0x01) == 0x01));
N
N//send register address in the first byte and then read 3 bytes from AFE4400
N	CSL_SPI_REGS->SPIDR2 = (Reg_address<<8)|0x00;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = (Reg_address<<8)|0x00;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 199 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);//chip select to be verifed
N	do
N	{
N	LLC_SPI_StatusRead(&sts);
N	}while(((sts & 0x02) != 0x01) && ((sts & 0x01) == 0x01));
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 208 56 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,0);
N	do
N	{
N		LLC_SPI_StatusRead(&sts);
N		spiBusStatus = (sts & SPI_STATUS_BUSY_MASK);
X		spiBusStatus = (sts & (0x00000001));
N		wordComplete = (sts & SPI_STATUS_WC_MASK );
X		wordComplete = (sts & (0x00000002) );
N	} while((SPI_STATUS_BUSY == spiBusStatus) && (wordComplete != SPI_WORD_COMPLETE));
X	} while(((0x0001) == spiBusStatus) && (wordComplete != (0x0002)));
N	dummy=CSL_SPI_REGS->SPIDR2;
X	dummy=((CSL_SpiRegsOvly) 0x3000)->SPIDR2;
N	SPI_Rx_buf[0]=CSL_SPI_REGS->SPIDR1;
X	SPI_Rx_buf[0]=((CSL_SpiRegsOvly) 0x3000)->SPIDR1;
N
N	CSL_SPI_REGS->SPIDR2 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0000;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 220 56 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,0);
N	do
N	{
...
N	dummy=CSL_SPI_REGS->SPIDR2;
X	dummy=((CSL_SpiRegsOvly) 0x3000)->SPIDR2;
N	SPI_Rx_buf[1]=CSL_SPI_REGS->SPIDR1;
X	SPI_Rx_buf[1]=((CSL_SpiRegsOvly) 0x3000)->SPIDR1;
N
N	CSL_SPI_REGS->SPIDR2 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0000;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 232 56 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_READ,8,0);
N	do
N	{
...
N	dummy=CSL_SPI_REGS->SPIDR2;
X	dummy=((CSL_SpiRegsOvly) 0x3000)->SPIDR2;
N	SPI_Rx_buf[2]=CSL_SPI_REGS->SPIDR1;
X	SPI_Rx_buf[2]=((CSL_SpiRegsOvly) 0x3000)->SPIDR1;
N
N
N	//send 0x000 to diable reading AFE4400
N	CSL_SPI_REGS->SPIDR2 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0000;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 246 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 254 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 262 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 271 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
N	return ((SPI_Rx_buf[0]<<16)|(SPI_Rx_buf[1]<<8)|SPI_Rx_buf[2]);
N
W "../src/SPO2_Init_Functions.c" 155 15 variable "dummy" was set but never used
W "../src/SPO2_Init_Functions.c" 156 6 variable "i" was declared but never referenced
W "../src/SPO2_Init_Functions.c" 156 8 variable "result" was set but never used
N}
N
Nvoid AFE44xx_Reg_Write(unsigned char reg_address, unsigned long data)
N{
N
N	unsigned int temp_data=data;
N	int i,result;
N	Uint16 sts;
N
N	//send 0x0000 to write AFE4400
N    //send 1st byte i.e address of control 0 register
N	CSL_SPI_REGS->SPIDR2 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = 0x0000;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 293 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 301 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 309 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 318 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
N//send register address in the first byte and then write 3 bytes of configuration data to AFE4400
N	CSL_SPI_REGS->SPIDR2 = (reg_address<<8)|0x00;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = (reg_address<<8)|0x00;
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 328 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
N	CSL_SPI_REGS->SPIDR2 =(unsigned int) ((data&0x00FF0000)>>8);
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 =(unsigned int) ((data&0x00FF0000)>>8);
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 337 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
N	CSL_SPI_REGS->SPIDR2 = (unsigned int) (data&0x0000FF00);
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = (unsigned int) (data&0x0000FF00);
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 346 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
N	CSL_SPI_REGS->SPIDR2 = (unsigned int)((data&0x0000FF)<<8);
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = (unsigned int)((data&0x0000FF)<<8);
N	CSL_SPI_REGS->SPIDR1 = 0x0000;
X	((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0x0000;
W "../src/SPO2_Init_Functions.c" 355 57 enumerated type mixed with another type
N	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,SPO2_AFE_Chip_Select);//chip select to be verifed
X	result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,0);
N	do
N	{
...
N
N
W "../src/SPO2_Init_Functions.c" 285 15 variable "temp_data" was declared but never referenced
W "../src/SPO2_Init_Functions.c" 286 6 variable "i" was declared but never referenced
W "../src/SPO2_Init_Functions.c" 286 8 variable "result" was set but never used
N}
N
N
N
Nvoid AFE44xx_Default_Reg_Init(void)
N{
N    unsigned char Reg_Init_i;
N    for ( Reg_Init_i = 0; Reg_Init_i < 49; Reg_Init_i++)
N    {
N      AFE44xx_Reg_Write(Reg_Init_i, AFE44xx_Default_Register_Settings[Reg_Init_i]);
N    }
N}
N
N
...
Nvoid AFE44xx_PowerOn_Init(void)
N{
N    volatile unsigned short Init_i, j;
N   // Init_AFE44xx_Resource();
N    for (j = 0; j < DELAY_COUNT; j++)
X    for (j = 0; j < 2; j++)
N    {
N      for ( Init_i =0; Init_i < 20000; Init_i++);
N      for ( Init_i =0; Init_i < 20000; Init_i++);
N      for ( Init_i =0; Init_i < 20000; Init_i++);
N    }
N   // Init_AFE44xx_DRDY_Interrupt();
N    AFE44xx_Default_Reg_Init();
N}
N
N/*EOF*/
