...
L 11 "../src/llc_uart.c" 2
N#include "llc_uartIf.h"
L 1 "../inc/llc_uartIf.h" 1
N/******************************************************************************
N**File Name			: llc_uartIf.h
N**File Description	:UART low-level controller interface
N**Created By		:
N**Creation Date		:
N**Last modified date:
N**Remarks			:
...
N
N
N#ifndef _LLC_UARTIF_H
N#define _LLC_UARTIF_H
N
N#include "llc_uartTypes.h"
L 1 "..\inc\llc_uartTypes.h" 1
N/******************************************************************************
N**File Name			: llc_uartTypes.h
N**File Description	:UART low-level controller interface
N**Created By		:
N**Creation Date		:
N**Last modified date:
...
N
N
N#ifndef _LLC_UARTTYPES_H
N#define _LLC_UARTTYPES_H
N
N#include <corazon.h>
...
N*/
N#endif
L 15 "..\inc\llc_uartTypes.h" 2
N
N/**
N * \defgroup LLCUartMain LLC UART Interface Definition
N *
N * Top-level Encapsulation of all documentation for UART LLC
N *
N * @{
N */
N
N/**
N * \defgroup LLCUartControllerSpecificDefs LLC Specific Definitions
N *
N * Definitions specific to this IP of the UART
N *
N * @{
N */
N
N
N#define LLC_UART_TX_FIFO_SIZE           16u
N/**< TX FIFO size */
N
N#define LLC_UART_RX_FIFO_SIZE           16u
N/**< RX FIFO size */
N
N#define LLC_UART_BAUD_MULTIPLIER        16u
N/**< Baud Multiplier */
N
N
Ntypedef Uint32   LLC_UartRegister;
N/**< LLC UART Register */
N
N/* @} LLCUartControllerSpecificDefs */
N
N
N/**
N * \defgroup LLCUartGenericDefs LLC UART Generic Definitions Structures
N *
N * UART definitions that are applicable to any controller and agnostic of a
N * specific IP block
N *
N * @{
N */
...
N typedef enum
N{
N    LLC_UART_PARITY_NONE    = 0x0,
N    /**< None Parity                                                        */
N    LLC_UART_PARITY_ODD     = 0x8,
N    /**< Odd Parity                                                         */
N    LLC_UART_PARITY_EVEN    = 0x18
N    /**< Even Parity                                                        */
N} LLC_UartParity;
N
Ntypedef enum
N{
N    LLC_UART_NUM_STOP_BITS_1    = 0,
N    /**< Number of stop bits == 1                                           */
N    LLC_UART_NUM_STOP_BITS_1_5  = 0x4,
N    /**< Number of stop bits == 1.5                                         */
N    LLC_UART_NUM_STOP_BITS_2    = 0x4
N    /**< Number of stop bits == 2                                           */
N} LLC_UartNumStopBits;
N
Ntypedef enum
N{
N    LLC_UART_CHARLEN_5  = 0x0,
N    /**< Number of bits in a char == 5                                      */
N    LLC_UART_CHARLEN_6  = 0x1,
N    /**< Number of bits in a char == 6                                      */
N    LLC_UART_CHARLEN_7  = 0x2,
N    /**< Number of bits in a char == 7                                      */
N    LLC_UART_CHARLEN_8  = 0x3
N    /**< Number of bits in a char == 8                                      */
N} LLC_UartCharLen;
N
Ntypedef enum
N{
N    LLC_UART_FLOWCONTROL_NONE   = 0,
N    /**< Neither HW,nor S/W flow Control */
N    LLC_UART_FLOWCONTROL_SW     = 1,
N    /**< Software Flow Control */
N    LLC_UART_FLOWCONTROL_HW     = 2
N    /**< Hardware Flow Control */
N} LLC_UartFlowControl;
N
N/**
N * Software Flow control
N * NOT SUPPORTED IN THIS DRIVER
N */
Ntypedef enum
N{
N    LLC_UART_SWFLOW_NONE        = 0,
N    /**< No Flow Control                                                    */
N    LLC_UART_SWFLOW_XONXOFF_1   = 2,
N    /**< Receiver/Transmitter compares XON1, XOFF1                          */
N    LLC_UART_SWFLOW_XONXOFF_2   = 1,
N    /**< Receiver/Transmitter compares XON2, XOFF2                          */
N    LLC_UART_SWFLOW_XONXOFF_12  = 3
N    /**< Receiver/Transmitter compares XON1, XON2; XOFF1, XOFF2             */
N} LLC_UartSwFlow;
N/**
N * Uart interrupts
N */
Ntypedef enum
N{
N    LLC_UART_INTR_RHR   = (1L << 0),
N    /**< Data ready in receive register                                     */
N    LLC_UART_INTR_THR   = (1L << 1),
N    /**< Transmitter empty interrupt                                        */
N    LLC_UART_INTR_RLS   = (1L << 2),
N    /**< A line status changed or an error condition was detected           */
N    LLC_UART_INTR_MS    = (1L << 3),
N    /**< Modem status interrupt */
N    LLC_UART_INTR_ALL   = (0xF)
N    /**< All interrupts */
N} LLC_UartIntr;
N
N/**
N * Uart receive trigger levels
N */
N
Ntypedef enum
N{
N    LLC_UART_RX_TRIG1   = 1,
N    /**< RX Trigger Level = 01                                              */
N    LLC_UART_RX_TRIG4   = 4,
N    /**< RX Trigger Level = 04                                              */
N    LLC_UART_RX_TRIG8   = 8,
N    /**< RX Trigger Level = 08                                              */
N    LLC_UART_RX_TRIG14  = 14
N    /**< RX Trigger Level = 14                                              */
N} LLC_UartRxTrigLvl;
N
N
N/**
N * \brief UART Basic configuration structure
N *
N * This structure contains the bacic uart configuration parameters.
N */
N
Ntypedef struct
N{
N    Uint32          moduleClock;
N    /**< Module Clock Frequency(Hz)                                         */
N    Uint32          baudRate;
N    /**< Division factor of the moduleClock that is used to derive the
N     * required baud on the wire                                            */
N    Bool            enableFifo;
N    /**< Enable/ Disable FIFO mode              \n
N     *  TRUE: Enable                            \n
N     *  False: Disable                          \n                          */
N    Bool            enableLoopback;
N    /**< Enable/ Disable Loopback operation     \n
N     *  TRUE: Enable                            \n
N     *  False: Disable                          \n                          */
N    Bool            enableXmitParityCheck;
N    /**< Enable/ Disable transmit parity check  \n
N     *  TRUE: Enable                            \n
N     *  False: Disable                          \n                          */
N    LLC_UartCharLen charLen;
N    /**< Length of each transmitted character, in bits                      */
N    LLC_UartNumStopBits numStopBits;
N    /**< Number of Stop bits                                                */
N    LLC_UartParity  parity;
N    /**< Even or Odd Parity                                                 */
N    LLC_UartRxTrigLvl rxThreshold;
N    /**< Trigger level setting for the RX FIFO                              */
N} LLC_UartBasicConfig;
N
N/**
N * \brief UART Flow control configuration structure
N *
N */
N
Ntypedef struct
N{
N    LLC_UartFlowControl fcType;
N    /**< Standard Flow Control Types                                        */
N    Bool    autoRtsCts;
N    /**< AUTO RTS/CTS Enable        \n
N     *  TRUE: Enable Auto RTS/CTS   \n
N     *  False: Disable Auto RTS/CTS \n                                      */
N} LLC_UartFlowControlConfig;
N
N/**
N * \brief UART hardware initialzation structure
N *
N * This structure contains the hardware initialization data. This is further
N * divided into three sub-sections. First set contains the UART hardware
N * setup/ initialization configuration. The next two contains the DMA Rx and
N * Tx hardware initialization configuration.
N */
Ntypedef struct
N{
N    LLC_UartBasicConfig         cfgBasic;
N    /**< UART Hardware control setup                                        */
N    LLC_UartFlowControlConfig   cfgFlowControl;
N    /**< UART Flow Control Setup                                            */
N} LLC_UartHwConfig;
N
Ntypedef Uint32 LLC_UartIntrStatus;
N
N/* @} LLCUartGenericDefs */
N
N/**
N * \defgroup LLCUartControllerSpecificDefs LLC Specific Definitions
N *
...
N    Uint32              instId;
N    /**< Instance number */
N    CSL_UartRegsOvly    regs;
N    /**< Register overlay */
N    Uint32              intrNum;
N    /**< Interrupt number */
N    Uint32              txFifoCount;
N    /**< TX Fifo counter - reflects currently available space in FIFO - maintained by the driver */
N    LLC_UartHwConfig    *hwConfig;
N    /**< Hardware configuration */
N} LLC_UartObj, *LLC_UartHandle;
N
N/* @} LLCUartControllerSpecificDefs */
N
N/* @} LLCUartMain */
N
N#endif  /* _LLC_UARTTYPES_H_ */
N/*EOF*/
L 15 "../inc/llc_uartIf.h" 2
N
N/**
N * \defgroup LLCUartMain LLC UART Interface Definition
N *
...
N
N/**
N * \defgroup LLCUartInterfaces LLC UART Interfaces
N *
N * Interfaces exported by the LLC, which are used to setup or operate the
N * controller in a specific mode of operation and in a specific manner
N *
N * @{
N */
N
N#define LLC_UART_LOOPBACK_MASK 0x10u
N
N#define LLC_UART_TRANSMITTER_EMPTY  0x40u
N
N#define LLC_UART_PARITY_MASK 0x18
N
N#define LLC_UART_STOP_BITS_MASK     0x4
N
N#define LLC_UART_NUM_DATA_BITS_MASK 0x3
N
N#define LLC_UART_TX_FIFO_RESET    0x04u
N/*#define LLC_uartClearXmitterFifo(hUart)                                     \
N    do {                                                                    \
N    } while(0)*/
X 
N/**< *** NOT USED/SUPPORTED IN THIS DRIVER VERSION ***  */
N
N#define LLC_UART_RX_FIFO_RESET    0x02u
N/*#define LLC_uartClearReceiverFifo(hUart)                                    \
N    do {                                                                    \
N    } while(0)*/
X 
N/**< *** NOT USED/SUPPORTED IN THIS DRIVER VERSION ***  */
N
N#define LLC_UART_UNRESET                    0x8000u
N#define LLC_UART_RESET                      0x0
N
N/* @} LLCUartControl */
N
N/**
N * \defgroup LLCUartIo LLC UART IO
N *
N * Interfaces for performing IO operations and for obtaining the status of
N * an IO operation
N *
N * @{
N */
N
N#define LLC_UART_HW_FLOW_CONTROL_ENABLE     0x22u
N#define LLC_UART_HW_FLOW_CONTROL_MASK       0x20u
N
N#define LLC_uartGetLineStatus(hUart)    ((hUart)->regs->LSR)
N/**< Get line status
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
N
N/**< This define reads the UART receive buffer registers and returns the read char
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
N
N #define LLC_UART_RX_LINE_ERR_MASK      (CSL_UART_LSR_PE_MASK | CSL_UART_LSR_FE_MASK | CSL_UART_LSR_BI_MASK)
N
N #define LLC_uartStatusIsXmitterFull(hUart)  (((hUart)->txFifoCount > 0) ? 0 : 1)
N/**< This returns the transmitter full status
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
N
N#define LLC_uartStatusIsOverrunError(hUart, status)     /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define LLC_uartStatusIsParityError(hUart, status)      /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define LLC_uartStatusIsFrameError(hUart, status)       /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define LLC_uartStatusIsBreakInd(hUart, status)         /**< *** NOT USED IN THIS DRIVER VERSION *** */
N
N/* @} LLCUartIo */
N
N/**
N * \defgroup LLCUartIntr LLC UART Interrupt Control
N *
N * Interfaces for controlling the Interrupt generation and handling and for
N * obtaining the status of an interrupt condition
N *
N * @{
N */
N
N#define LLC_uartIntrGetStatus(hUart)   ((hUart)->regs->IIR & 0xFu)
N/**< Get interrupt status */
N
N#define LLC_UART_RX_LINE_STATUS_INT         0x6u
N#define LLC_uartIntrIsReceiverLineError(hUart, status)  (((status) == (Uint32)LLC_UART_RX_LINE_STATUS_INT) ? 1 : 0)
N/**< Return 1 if receiver line error */
N
N
N#define LLC_UART_RX_DATA_AVAILABLE_INT      0x4u
N#define LLC_uartIntrIsDataReceived(hUart, status)       (((status) == LLC_UART_RX_DATA_AVAILABLE_INT) ? 1 : 0)
N/**< Return 1 if data received */
N
N
N#define LLC_UART_RX_CHAR_TIMEOUT_INT        0xCu
N#define LLC_uartIntrIsCharacterTimeout(hUart, status)   (((status) == LLC_UART_RX_CHAR_TIMEOUT_INT) ? 1 : 0)
N/**< Return 1 if character timeout occured */
N
N
N#define LLC_UART_TX_HOLDING_REG_EMPTY_INT   0x2u
N#define LLC_uartIntrIsXmitterHoldingRegEmpty(hUart, status)   (((status) == LLC_UART_TX_HOLDING_REG_EMPTY_INT) ? 1 : 0)
N/**< Return 1 if character timeout occured */
N
N#define LLC_UART_MODEMSTAT_INT              0x0
N#define LLC_uartIntrIsModemStatus(hUart, status)        (((status) == LLC_UART_MODEMSTAT_INT) ? 1 : 0)
N/**< Return 1 if modem status event occured */
N
N#define LLC_uartIntrIsSpecialChar(hUart, status)        0
N/**< Special character identification not supported - return 0 always */
N
N#define _LLC_UART_LCR_STORE(val)        /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define _LLC_UART_LCR_RESTORE(val)      /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define _LLC_UART_SETLCR_BF             /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define _LLC_UART_SETLCRBIT7_0          /**< *** NOT USED IN THIS DRIVER VERSION *** */
N#define _LLC_UART_SETLCRBIT7_1          /**< *** NOT USED IN THIS DRIVER VERSION *** */
N
N#define LLC_uartModemSetDtr(hUart, flag)                /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N#define LLC_uartModemSetRts(hUart, flag)                /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N#define LLC_uartModemSetRi(hUart, flag)                 /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N#define LLC_uartModemSetDcd(hUart, flag)                /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N#define LLC_uartEnableAutoFlowControl(hUart, flag)      /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N#define LLC_uartModemGetStatus(hUart, bitmap)           /**< *** NOT SUPPORTED IN THIS DRIVER VERSION *** */
N
N/* @} LLCUartModem */
N
N/**
N * \defgroup LLCUartDma LLC UART DMA Operation and Control
N *
N * NOT SUPPORTED IN THIS DRIVER VERSION
N *
N * Interfaces for programming the DMA and for obtaining the status of a
N * specific DMA channel
N *
N * @{
N */
N
Nextern Int  LLC_uartGetIntrNum(
N                Int                     deviceId);
Nextern void LLC_uartInit(
N                Ptr                     uartObj,
N                Uint32                  instId);
Nextern void LLC_uartHwSetup(
N                LLC_UartHandle      hUart,
N                Ptr                 hHwConfig,
N                Bool                enableDma);
N
N
N/**< This clears the line status
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
N
N
N/* @} LLCUartIntr */
N
Nextern  void LLC_uartClearXmitterFifo(LLC_UartHandle hUart);
N
Nextern  void LLC_uartClearReceiverFifo(LLC_UartHandle hUart);
N
Nextern  void LLC_uartSetReceiverThreshold(LLC_UartHandle hUart, Uint32 threshold);
N
N
Nextern  void LLC_uartReset(LLC_UartHandle hUart);
N
Nextern  void LLC_uartEnableHwFlowControl(LLC_UartHandle hUart);
N
Nextern  void LLC_uartDisableHwFlowControl(LLC_UartHandle hUart);
N
Nextern  Uint32 LLC_uartRead(LLC_UartHandle hUart);
N
Nextern void LLC_uartEnableLoopback(LLC_UartHandle hUart);
N
Nextern void LLC_uartEnableParity(LLC_UartHandle hUart, Uint32 parity);
N
Nextern void LLC_uartSetNumStopBits(LLC_UartHandle hUart, Uint32 numBits);
N
Nextern void LLC_uartDisableLoopback(LLC_UartHandle hUart);
N
Nextern void LLC_uartSetTxFifoCntFull(LLC_UartHandle hUart,Bool fifoEnabled);
N
Nextern  Int LLC_uartStatusIsLineError(LLC_UartHandle hUart);
N
Nextern  Int LLC_uartHandleRxError(LLC_UartHandle hUart);
N
Nextern  Int LLC_uartStatusIsDataReady(LLC_UartHandle hUart);
N
Nextern  void LLC_uartWrite(LLC_UartHandle hUart, Char ch);
N
Nextern  Int LLC_uartIntrIsXmitterEmpty(LLC_UartHandle hUart);
N
Nextern  Int LLC_uartIntrIsPending(LLC_UartHandle hUart);
N
Nextern  void LLC_uartIntrEnable(LLC_UartHandle hUart, LLC_UartRegister bitmask);
N
Nextern void LLC_uartIntrDisable(LLC_UartHandle hUart, LLC_UartRegister bitmask);
N
N
Nextern  void LLC_uartClearLineStatus(LLC_UartHandle hUart);
N
Nextern void LLC_uartSetBaudRate(LLC_UartHandle hUart, Uint32 baudRate);
N
Nextern void LLC_uartSetNumDataBits(LLC_UartHandle hUart, Uint32 numBits);
N
N/* @} LLCUartInterfaces */
N
N/* @} LLCUartMain */
N
N#endif  /* _LLC_UARTIF_H_ */
N/*EOF*/
L 12 "../src/llc_uart.c" 2
N#include "llc_uartTypes.h"
N
N#define CSL_INTC_EVENTID_UARTINT	(0x09u) //HS: Caution: To be verified.
N
N/*
N *================================
...
N/*
N *=============================================
N * Definitions of Externally Visible Functions
N *=============================================
N */
N
N/* Init UART LLC */
...
N{
N    Uint16 regs;
N    LLC_UartObj    *uartObj;
N
N    regs    = 0;
N    uartObj = (LLC_UartObj *)hUartObj;
N    uartObj->instId = instId;
N
N    /* Set the base address and interrupt number */
N    switch (uartObj->instId) {
N        case 0:
N            uartObj->intrNum = CSL_INTC_EVENTID_UARTINT;
X            uartObj->intrNum = (0x09u);
N            regs = (Uint32)CSL_UART_REGS;
X            regs = (Uint32)((CSL_UartRegsOvly) 0x1B00);
N            break;
N
N        default:
N            uartObj->intrNum = 0xFFFFu;
N            /* Large number outside interrut number range */
N            regs = 0;
N			break;
N    }
N    uartObj->regs = (CSL_UartRegsOvly)regs;
N    return;
N}
N
N
N/* Hardware setup of UART LLC */
Nvoid LLC_uartHwSetup(
N                LLC_UartHandle      hUart,
N                Ptr                 hHwConfig,
N                Bool                enableDma)
N{
...
N    LLC_UartHwConfig*  hwConfig;
N
N	hwConfig = (LLC_UartHwConfig*)hHwConfig;
N    hUart->hwConfig = hwConfig;
N
N    /* Set the divisor */
N    value = hwConfig->cfgBasic.moduleClock / \
N    (LLC_UART_BAUD_MULTIPLIER * hwConfig->cfgBasic.baudRate);
X    value = hwConfig->cfgBasic.moduleClock /     (16u * hwConfig->cfgBasic.baudRate);
N
N	hUart->regs->PWREMU_MGMT |= 0x01u;
N
N    hUart->regs->DLL = (Uint8)(value & 0xFF);
N    hUart->regs->DLH = (Uint8) ((value & 0xFF00) >> 8);
N
N    /* Set the Fifo control - FIFO Disable not supported */
N    hUart->regs->FCR = 0; /* Clear FIFO counters */
X    hUart->regs->IIR = 0;  
N
N    value = 0;
N    if(hwConfig->cfgBasic.enableFifo == (Bool)TRUE)
X    if(hwConfig->cfgBasic.enableFifo == (Bool)1)
N    {
N      value = (CSL_UART_FCR_FIFOEN_ENABLE);
X      value = ((0x0001u));
N      /* | CSL_UART_FCR_TXCLR_MASK | CSL_UART_FCR_RXCLR_MASK);*/
N      switch (hwConfig->cfgBasic.rxThreshold)
N       {
N         case 1:
N            value |= 0x0;   /* Receive FIFO trigger level 1 byte */
N            break;
N         case 4:
N            value |= 0x40u;   /* Receive FIFO trigger level 4 byte */
N            break;
N         case 8:
N            value |= 0x80u;   /* Receive FIFO trigger level 8 byte */
N            break;
N         case 14:
N         default:
N            value |= 0xC0u;   /* Receive FIFO trigger level 14 byte */
N            break;
N       }
N    }
N    if(TRUE == enableDma)
...
N    }
N
N    hUart->regs->FCR = value;
X    hUart->regs->IIR = value;
N
N    /* Set other parameters based upon configuration */
N    hUart->regs->MCR = 0;  /* modem control register not programmed */
N
N    value = ((Uint32) hwConfig->cfgBasic.charLen |
N             (Uint32) hwConfig->cfgBasic.numStopBits |
N             (Uint32) hwConfig->cfgBasic.parity);
N    hUart->regs->LCR = value;
N
N    hUart->regs->PWREMU_MGMT |= 0x01u;
N
N    return;
N}
N
N/* Get interrupt number from LLC */
NInt LLC_uartGetIntrNum(Int deviceId)
N{
N    Uint32     intrNum;
N    Int        ret_intrNum;
N
...
N    switch (deviceId) {
N	    case 0:
N	        intrNum = CSL_INTC_EVENTID_UARTINT;
X	        intrNum = (0x09u);
N	        break;
N
N	    default:
N	        intrNum = 0xFFFFFFFF; /* Error */
N			break;
N	    }
N
N    ret_intrNum = (Int)intrNum;
N    return (ret_intrNum);
N}
N
Nvoid LLC_uartSetTxFifoCntFull(LLC_UartHandle hUart,Bool fifoEnabled)
N{
N    if(fifoEnabled != FALSE)
X    if(fifoEnabled != 0)
N    {
N       hUart->txFifoCount = LLC_UART_TX_FIFO_SIZE;
X       hUart->txFifoCount = 16u;
N    }
N    else
N    {
N      hUart->txFifoCount = 1u;
N    }
N}
N
N/**
N * \defgroup LLCUartConfig LLC UART Configuration
N *
N * Interfaces for configuring the UART controller for a specific mode of
N * operation
N *
N * @{
N */
Nvoid LLC_uartEnableLoopback(LLC_UartHandle hUart)
N{
N    LLC_UartRegister mcr;
N    mcr = hUart->regs->MCR;
N    mcr &= (~LLC_UART_LOOPBACK_MASK);
X    mcr &= (~0x10u);
N    mcr |= LLC_UART_LOOPBACK_MASK;
X    mcr |= 0x10u;
N    hUart->regs->MCR = mcr;
N}
N
N/**< Put the UART in loopback mode of operation.
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
Nvoid LLC_uartDisableLoopback(LLC_UartHandle hUart)
N{
N    LLC_UartRegister mcr;
N    mcr = hUart->regs->MCR;
N    mcr &= (~LLC_UART_LOOPBACK_MASK);
...
N}
N
N/**< Take the UART out of loopback mode of operation.
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
Nvoid LLC_uartEnableParity(LLC_UartHandle hUart, Uint32 parity)
N{
N    LLC_UartRegister lcr;
N    lcr = hUart->regs->LCR;
N    lcr &= (~LLC_UART_PARITY_MASK);
X    lcr &= (~0x18);
N    lcr |= (Uint32)parity;
N    hUart->regs->LCR = lcr;
N}
N
N/**< This enables parity generation and detection. Odd/ Even parity is
N * specified through the parameter.
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   parity  [IN]    {LLC_UartParity}
N *                              LLC_UART_PARITY_NONE: No Parity
N *                              LLC_UART_PARITY_ODD: Odd Parity,
N *                              LLC_UART_PARITY_EVEN: Even Parity           */
Nvoid LLC_uartSetNumStopBits(LLC_UartHandle hUart, Uint32 numBits)
N{
N    LLC_UartRegister lcr;
N    lcr = hUart->regs->LCR;
N    lcr &= (~LLC_UART_STOP_BITS_MASK);
X    lcr &= (~0x4);
N    lcr |= (Uint32)numBits;
N    hUart->regs->LCR = lcr;
N}
N
N/**< This programs the number of Stop bits to be used when transmitting
N * data and the same number to be assumed when receiving data.
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   numBits [IN]    {LLC_UartNumStopBits}   Number of stop bits,
N *                              LLC_UART_NUM_STOP_BITS_1: 1 Stop-bit,
N *                              LLC_UART_NUM_STOP_BITS_1_5: : 1.5 Stop-bits,
N *                              LLC_UART_NUM_STOP_BITS_2: : 2 Stop-bits     */
Nvoid LLC_uartSetNumDataBits(LLC_UartHandle hUart, Uint32 numBits)
N{
N    LLC_UartRegister lcr;
N    lcr = hUart->regs->LCR;
N    lcr &= (~LLC_UART_NUM_DATA_BITS_MASK);
X    lcr &= (~0x3);
N    lcr |= (Uint32)numBits;
N    hUart->regs->LCR = lcr;
N}
N
N/**< This programs the number of Data bits to be used when transmitting
N * data and the same number to be assumed when receiving data.
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   numBits [IN]    {LLC_UartNumDataBits}   Number of Data bits,
N *                              LLC_UART_NUM_DATA_BITS_5: 5 Data bits,
N *                              LLC_UART_NUM_DATA_BITS_6: 6 Data bits,
N *                              LLC_UART_NUM_DATA_BITS_7: 7 Data bits,
N *                              LLC_UART_NUM_DATA_BITS_8: 8 Data bits       */
Nvoid LLC_uartSetBaudRate(LLC_UartHandle hUart, Uint32 baudRate)
N{
N        Uint32 value;
N        value = (Uint32)( (Uint32)(hUart->hwConfig->cfgBasic.moduleClock) / (Uint32)((Uint32)LLC_UART_BAUD_MULTIPLIER * (Uint32)baudRate) );
X        value = (Uint32)( (Uint32)(hUart->hwConfig->cfgBasic.moduleClock) / (Uint32)((Uint32)16u * (Uint32)baudRate) );
N        if (((((Uint32)(hUart->hwConfig->cfgBasic.moduleClock)) %
N        		((Uint32)baudRate))) > ((Uint32)(baudRate/2))) {
N            /* Rouding off required */
N            if ((value & 0xFF)  != 0xFF) {
N                hUart->regs->DLL = (Uint8)(value & 0xFF) + 1;
N                hUart->regs->DLH = (Uint8)((value & 0xFF00) >> 8);
N            } else {
N                hUart->regs->DLL = (Uint8)(value & 0xFF);
N                hUart->regs->DLH = (Uint8)(((value & 0xFF00) +1) >> 8);
N            }
N        } else {
N            /* Rounding off not required */
N            hUart->regs->DLL = (Uint8)(value & 0xFF);
N            hUart->regs->DLH = (Uint8)((value & 0xFF00) >> 8);
N        }
N}
N
N/**< Set the baud rate at which the UART must operate in.
N * \param   hUart       [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   baudRate    [IN]    {Int}           Baud rate provided by upper layer
N */
N/* @} LLCUartConfig */
N
N/**
N * \defgroup LLCUartControl LLC UART Control
N *
N * Interfaces for controlling the operation of the UART controller when in a
N * specific mode of operation
N *
N * \note    Except for Reset none of the other operations are USED/SUPPORTED
N *          IN THIS DRIVER VERSION
N *
N * @{
N */
Nvoid LLC_uartClearXmitterFifo(LLC_UartHandle hUart)
N{
N   hUart->regs->FCR |= LLC_UART_TX_FIFO_RESET;
X   hUart->regs->IIR |= 0x04u;
N}
N
N/**< Clear the Tx FIFO.
N * \param   hUart       [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N */
Nvoid LLC_uartClearReceiverFifo(LLC_UartHandle hUart)
N{
N   hUart->regs->FCR |= LLC_UART_RX_FIFO_RESET;
X   hUart->regs->IIR |= 0x02u;
N}
N
N/**< Clear the Rx FIFO.
N * \param   hUart       [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N */
N
Nvoid LLC_uartSetReceiverThreshold(LLC_UartHandle hUart, Uint32 threshold)
N{
N       hUart->regs->FCR |= threshold;
X       hUart->regs->IIR |= threshold;
N}
N
N/**< Set the Rx FIFO threshold.
N * \param   hUart       [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   threshold   [IN]    {Uint32} Threshold value for Rx FIFO
N */
Nvoid LLC_uartReset(LLC_UartHandle hUart)
N{
N    volatile Uint32 cnt;
N
N    cnt = 10000u;
N		/* Reset Counter value */
N//	*(ioport volatile unsigned *)0x1C04=0x2;
N
N	/* UART Module out of reset */
N//	*(ioport volatile unsigned *)0x1C05&=0x7f;
N
N/* changing parallel port mode to 5 - supports UART */
N//	*(ioport volatile unsigned *)0x1C00=0x5000;
N
N/* changing parallel port mode to 1 - supports UART */
N//	*(ioport volatile unsigned *)0x1C00=0x1000;
N
N	/* changing parallel port mode to 4 - supports UART */
N//	*(ioport volatile unsigned *)0x1C00=0x4000;
N
N    hUart->regs->PWREMU_MGMT = LLC_UART_RESET;
X    hUart->regs->PWREMU_MGMT = 0x0;
N    while (--cnt > 0)
N    {
N        ;
N    }
N   // hUart->regs->PWREMU_MGMT = LLC_UART_UNRESET | 0xE003u ;
N   hUart->regs->PWREMU_MGMT |= 0xE000;
N}
N
N/**< This resets the UART and brings it out of reset
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object  */
Nvoid LLC_uartEnableHwFlowControl(LLC_UartHandle hUart)
N{
N    LLC_UartRegister mcr;
N    mcr = hUart->regs->MCR;
N    mcr &= (~LLC_UART_HW_FLOW_CONTROL_MASK);
X    mcr &= (~0x20u);
N    mcr |= LLC_UART_HW_FLOW_CONTROL_ENABLE;
X    mcr |= 0x22u;
N    hUart->regs->MCR = mcr;
N}
N
N/**< This enables the hardware flow control for the UART - the hardware supports
N *   auto rts/cts functionality
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
Nvoid LLC_uartDisableHwFlowControl(LLC_UartHandle hUart)
N{
N    LLC_UartRegister mcr;
N    mcr = hUart->regs->MCR;
N    mcr &= (~LLC_UART_HW_FLOW_CONTROL_MASK);
...
N}
N
N/**< This disables the hardware flow control for the UART - the hardware supports
N *   auto rts/cts functionality
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
NUint32 LLC_uartRead(LLC_UartHandle hUart)
N {
N    Uint32  dummy;
N
N    while ((LLC_uartGetLineStatus(hUart)) & LLC_UART_RX_LINE_ERR_MASK)
X    while ((((hUart)->regs->LSR)) & ((0x0004u) | (0x0008u) | (0x0010u)))
N    {
N        dummy = hUart->regs->RBR;
N        dummy = dummy;
N    }
N
N    return (hUart->regs->RBR);
N }
N
NInt LLC_uartStatusIsLineError(LLC_UartHandle hUart)
N{
N    Uint32 status;
N
N    status = LLC_uartGetLineStatus(hUart);
X    status = ((hUart)->regs->LSR);
N
N    return (Int) ((status & CSL_UART_LSR_RXFIFOE_MASK ) ? 1 : 0);
X    return (Int) ((status & (0x0080u) ) ? 1 : 0);
N}
N
NInt LLC_uartHandleRxError(LLC_UartHandle hUart)
N{
N    return (LLC_uartStatusIsLineError(hUart));
N}
N
NInt LLC_uartStatusIsDataReady(LLC_UartHandle hUart)
N{
N    Uint32 status;
N
N    status = LLC_uartGetLineStatus(hUart);
X    status = ((hUart)->regs->LSR);
N
N    /* Added for error checks */
N    if ( (status & CSL_UART_LSR_RXFIFOE_MASK) != FALSE )
X    if ( (status & (0x0080u)) != 0 )
N    {
N        LLC_uartHandleRxError(hUart);
N    }
N
N    return (Int) ((status & CSL_UART_LSR_DR_MASK ) ? 1 : 0);
X    return (Int) ((status & (0x0001u) ) ? 1 : 0);
N}
N
N/**< Return 1 if data ready
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
Nvoid LLC_uartWrite(LLC_UartHandle hUart, Char ch)
N{
N    --hUart->txFifoCount;
N    //hUart->regs->THR = (Uint32)ch;
N	hUart->regs->RBR = (Uint32)ch;
N}
N
N/**< This define writes the character to the UART transmit holding register and
N *   decremens the Tx FIFO count
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object   */
NInt LLC_uartIntrIsXmitterEmpty(LLC_UartHandle hUart)
N{
N    LLC_UartIntrStatus  status;
N
N    status = LLC_uartGetLineStatus(hUart);
X    status = ((hUart)->regs->LSR);
N    return (Int) (((status & CSL_UART_LSR_TEMT_MASK) == CSL_UART_LSR_TEMT_MASK) ? 1: 0);
X    return (Int) (((status & (0x0040u)) == (0x0040u)) ? 1: 0);
N}
N
N/**< Return 1 if transmitter is empty */
NInt LLC_uartIntrIsPending(LLC_UartHandle hUart)
N{
N    Uint32 status;
N
N    status = hUart->regs->IIR & 0xFu;
N    if( (status & 0x1u) != (Bool)FALSE)
X    if( (status & 0x1u) != (Bool)0)
N    {
N        status = 0;
N    }
N    else
...
N}
N
N/**< Return status of pending interrupt */
Nvoid LLC_uartIntrEnable(LLC_UartHandle hUart, LLC_UartRegister bitmask)
N{
N    LLC_UartRegister temp;
N
N    temp = hUart->regs->IER;
N    temp |= (bitmask & 0xFFu);
N    hUart->regs->IER = temp;
N}
N
N/**< This enables the UART interrupt as per mask
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   bitmask [IN]    Mask for interrupt enable                       */
Nvoid LLC_uartIntrDisable(LLC_UartHandle hUart, LLC_UartRegister bitmask)
N{
N    LLC_UartRegister    temp;
N
N    temp = hUart->regs->IER;
N    temp &= (~bitmask);
N    hUart->regs->IER = temp & 0xFFu;
N}
N
N/**< This disables the UART interrupt as per mask
N * \param   hUart   [IN]    {LLC_UartObj *} Handle to the LLC Uart Object
N * \param   bitmask [IN]    Mask for interrupt disable                      */
Nvoid LLC_uartClearLineStatus(LLC_UartHandle hUart)
N{
N    while (LLC_uartStatusIsLineError(hUart))
N    {
N        volatile Char   tempChar = (Char)LLC_uartRead(hUart);
N    }
N}
N/*EOF*/
N
