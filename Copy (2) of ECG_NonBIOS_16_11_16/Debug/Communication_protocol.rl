L 1 "../src/Communication_protocol.c"
N /******************************************************************************
N**File Name			: Communication_protocol.c
N**File Description	:
N**Author    		: Vuon1
...
L 14 "../inc/Communication_protocol.h" 2
...
N
N/*EOF*/
L 15 "../inc/Communication_protocol.h" 2
...
N*/
N#endif
L 16 "../inc/Communication_protocol.h" 2
...
N    Uint16      frameLen;
X    unsigned short      frameLen;
N    Uint16      wordCnt;
X    unsigned short      wordCnt;
N    Uint16      wordLen;
X    unsigned short      wordLen;
...
N                    Uint32       spiClkRate,
X                    unsigned long       spiClkRate,
N                    Uint16       frameLength,
X                    unsigned short       frameLength,
N                    Uint16       wordLength);
X                    unsigned short       wordLength);
N
N/**
...
Xunsigned short DDC_SPI_Close(SPI_Handle *spiHandle);
N
N/**
...
X                         unsigned short     *transactionBuffer,
N                         Uint16     count,
X                         unsigned short     count,
N                         Uint16     readOrWrite);
X                         unsigned short     readOrWrite);
N
N/**
...
N                    Uint16      *readBuf,
X                    unsigned short      *readBuf,
N                    Uint16      readCnt,
X                    unsigned short      readCnt,
N                    Uint16      wLen);
X                    unsigned short      wLen);
N
N/**
...
N                    Uint16      *writeBuf,
X                    unsigned short      *writeBuf,
N                    Uint16      writeCnt,
X                    unsigned short      writeCnt,
N                    Uint16      wLen);
X                    unsigned short      wLen);
N
N/**
...
N                    Uint16      *cmdBuf,
X                    unsigned short      *cmdBuf,
N                    Uint16      cmdCnt,
X                    unsigned short      cmdCnt,
N                    Uint16      cLen,
X                    unsigned short      cLen,
N                    Uint16      rdOrWr);
X                    unsigned short      rdOrWr);
N
N/**
...
X              unsigned short wordLen,
N              Uint16 slaveNo,
X              unsigned short slaveNo,
N              Uint16 dataDly,
X              unsigned short dataDly,
N              Uint16 csPol,
X              unsigned short csPol,
N              Uint16 clkPh,
X              unsigned short clkPh,
N              Uint16 clkPol);
X              unsigned short clkPol);
N/**
...
XPSP_Result SPI_WRITE_BYTES(unsigned short data);
N
N/**
...
Xvoid draw_string (unsigned short , unsigned short , char* ,unsigned long );
Nvoid draw_font(Uint16, Uint16, Uint16,Uint32);
Xvoid draw_font(unsigned short, unsigned short, unsigned short,unsigned long);
NInt32 drawLine( Uint16 , Uint16, Uint16, Uint16, Uint16, Uint16);
Xint drawLine( unsigned short , unsigned short, unsigned short, unsigned short, unsigned short, unsigned short);
Nvoid  cmdWrite(Uint16);
Xvoid  cmdWrite(unsigned short);
Nvoid  dataWrite(Uint16);
Xvoid  dataWrite(unsigned short);
N//void LCD_hr_status_update(void);
Nvoid LCD_clear_window(Uint16,Uint16,Uint16,Uint16);
Xvoid LCD_clear_window(unsigned short,unsigned short,unsigned short,unsigned short);
...
Xvoid draw_font_HR(unsigned short, unsigned short, unsigned short,unsigned long);
Nvoid draw_font_Lead(Uint16, Uint16, Uint16,Uint32);
Xvoid draw_font_Lead(unsigned short, unsigned short, unsigned short,unsigned long);
N#endif
N/*EOF*/
L 29 "..\inc\ECGSystemInit.h" 2
N#include "I2C.h"
L 1 "..\inc\I2C.h" 1
N/******************************************************************************
N**File Name			: I2C.h
...
X    short lead_info_data[(((500))/2)][(8)];
N	
N}ECG_Lead_Info;
N
N#endif
...
N/*EOF*/
L 10 "../src/Communication_protocol.c" 2
N#include "csl_ioport.h"
N
N
Nextern Uint8 Heart_Rate;
Xextern unsigned char Heart_Rate;
Nextern Uint8 Respiration_Rate;
Xextern unsigned char Respiration_Rate;
Nextern Uint8 SPO2_Percentage;
Xextern unsigned char SPO2_Percentage;
N
Nextern Uint8 Normal_Mode;
Xextern unsigned char Normal_Mode;
Nextern Uint8 Patient_change;
Xextern unsigned char Patient_change;
Nextern Uint8 NIBP_Pediatric_Mode;
Xextern unsigned char NIBP_Pediatric_Mode;
Nextern Uint8 Notch_Filter_60_Hz;
Xextern unsigned char Notch_Filter_60_Hz;
N
Nextern Uint8 Diagnostics_StsRegister;
Xextern unsigned char Diagnostics_StsRegister;
Nextern Uint8 Flag_StsRegister;
Xextern unsigned char Flag_StsRegister;
Nextern Uint8 ECG_gain;
Xextern unsigned char ECG_gain;
Nextern Uint8 ECG_gain_bit0;
Xextern unsigned char ECG_gain_bit0;
Nextern Uint8 ECG_gain_bit1;
Xextern unsigned char ECG_gain_bit1;
N
Nextern Uint8 ModeNIBPmode_ECGConfig_Notchfreq_Config_CmdRegister;
Xextern unsigned char ModeNIBPmode_ECGConfig_Notchfreq_Config_CmdRegister;
Nextern Uint8 ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister;
Xextern unsigned char ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister;
Nextern Uint8 Power_Config_CmdRegister;
Xextern unsigned char Power_Config_CmdRegister;
N extern Uint8 Power_Config_StsRegister;
X extern unsigned char Power_Config_StsRegister;
Nextern Uint8 NIBP_IntervalSet_CmdRegister;
Xextern unsigned char NIBP_IntervalSet_CmdRegister;
Nextern Uint8 NIBP_IntervalSet_StsRegister;
Xextern unsigned char NIBP_IntervalSet_StsRegister;
N/*-------------------------------------------------------------------------
N**  Function Name		: pack(void* p,Uint8 data_index,Uint8 no_of_data_points,Uint8* pack)
N**  Description 		: makes packet in the following format
N**
N		start byte		:1 byte $=0x24h
N		data index		:8 bits
N		overflow bits	:1 bit
N		packet number	:15 bits
N		data			:no_of_datapoints*8
N		stop byte		:8 bits
N
N**  Intput parameters   : data_index, no_of_datapoints, packet pointer
...
Xunsigned char pack(void* p,unsigned char data_index,unsigned char no_of_data_points,unsigned char* pack)
N{
N	int i,j,no_of_bytes;
N	Uint8 k=0;
X	unsigned char k=0;
N
N	static Uint8 overflow_buffer[15];
X	static unsigned char overflow_buffer[15];
N	static Uint16 packet_identifier_buffer[15];
X	static unsigned short packet_identifier_buffer[15];
N
N
N	pack[0]=START;
X	pack[0]=0x24;
N	pack[1]=data_index;
N	pack[2]=(overflow_buffer[data_index]<<7)|((packet_identifier_buffer[data_index]&0xFF00)>>8);
N	pack[3]=(packet_identifier_buffer[data_index]&0x00FF);
N
N
N	if((data_index==1)||(data_index==2)|| (data_index==3)|| (data_index==7)|| (data_index==8)||(data_index==9)|| (data_index==10)||(data_index==12))
N	{
N		int j=0;
N		no_of_bytes=2;
N		for(j=0;j<no_of_data_points;j++)
N		{	for(i=0;i<no_of_bytes;i++)
N			{
N				k=4+(j*no_of_bytes+i);
N				pack[k]=((0xFF<<((no_of_bytes-(i+1))*8))&(((int *)p)[j]))>>((no_of_bytes-(i+1))*8);
N			}
N		}
N	}
N
N	else if(data_index==4)
N	{
N		no_of_bytes=4;
N		for(j=0;j<no_of_data_points;j++)
N		{	for(i=0;i<no_of_bytes;i++)
N			{
N				k=4+(j*no_of_bytes+i);
N				pack[k]=((0xFF<<((no_of_bytes-(i+1))*8))&(((long *)p)[j]))>>((no_of_bytes-(i+1))*8);
N			}
N		}
N	}
N	k++;
N	pack[k]=0x2A;
N	packet_identifier_buffer[data_index]++;
N	if(packet_identifier_buffer[data_index]==32767)
N	{
N		overflow_buffer[data_index]=1;
N	}
N	return (k+1);
N}
N
N/*-------------------------------------------------------------------------
N**  Function Name		: pack_to_MSP(Uint8 data,Uint8 data_index,Uint8* pack)
N**  Description 		: forms datapacket to be sent to MSP
...
N
N/*-------------------------------------------------------------------------
N**  Function Name		: receive_uartdata()
N**  Description 		: receives data from START to STOP
N**  Intput parameters   : None
N**  Output parameters	: None
N** 	Returns				: void
N**-------------------------------------------------------------------------*/
Nvoid receive_uartdata(void )
N{
N	 static unsigned int i=0,uart_status=0;
N	 extern Uint8 uart_msp_data;
X	 extern unsigned char uart_msp_data;
N	 unsigned char uart_data;
N 	 static unsigned char data_buffer[10]={0};
N 	 uart_data=uart_msp_data;
N
N		if(uart_data==START)
X		if(uart_data==0x24)
N		{
N			uart_status=START_BYTE_RECEIVED;
X			uart_status=1;
N		}
N		else if(uart_data==STOP)
X		else if(uart_data==0x2A)
N		{
N			uart_status=STOP_BYTE_RECEIVED;
X			uart_status=2;
N		}
N		if(uart_status==START_BYTE_RECEIVED)
X		if(uart_status==1)
N		{
N			data_buffer[i]=uart_data;
N			i++;
N		}
N		if(uart_status==STOP_BYTE_RECEIVED)
X		if(uart_status==2)
N		{	uart_status=IDLE;
X		{	uart_status=0;
N
N			data_buffer[i]=uart_data;
N			unpack_uartdata(data_buffer);
N			i=0;
N		}
N
N}
...
N}
N/*-------------------------------------------------------------------------
N**  Function Name		: send_via_spi(Uint8 no_of_datapoints,Uint8* datapack)
N**  Description 		: receives data from START to STOP
N**  Intput parameters   : no_of_datapoints, datapack pointer
N**  Output parameters	: None
N** 	Returns				: void
N**-------------------------------------------------------------------------*/
Nvoid send_via_spi(Uint8 no_of_datapoints,Uint8* datapack)
...
N	int i,result;
N	Uint16 sts;
X	unsigned short sts;
N	for(i=0;i<no_of_datapoints;i++)
N	{
N			CSL_SPI_REGS->SPIDR2 = (datapack[i]<<8)|0x00;
X			((CSL_SpiRegsOvly) 0x3000)->SPIDR2 = (datapack[i]<<8)|0x00;
N			CSL_SPI_REGS->SPIDR1 = 0;
X			((CSL_SpiRegsOvly) 0x3000)->SPIDR1 = 0;
N		   //    result = LLC_SPI_CmdSet(SPI_WRITE);
W "../src/Communication_protocol.c" 173 59 enumerated type mixed with another type
N			result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,MB_chip_select);
X			result= LLC_SPI_CmdSet_WLenSet_SlaveSelect(SPI_WRITE,8,1);
N			do
N			{
...
N
N	}
W "../src/Communication_protocol.c" 166 8 variable "result" was set but never used
N}
N
N/*-------------------------------------------------------------------------
N**  Function Name		: send_via_uart(Uint8 no_of_datapoints, Uint8* datapack)
N**  Description 		: receives data from START to STOP
N**  Intput parameters   : no_of_datapoints, datapack pointer
N**  Output parameters	: None
N** 	Returns				: void
...
N	for(i=0;i<no_of_datapoints;i++)
N	{
N		EVM5515_UART_putChar(datapack[i]);
N		while((UART_LSR&0x0020)==0);/*wait till THR is empty*/
X		while((*(volatile ioport unsigned short*)(0x1B0A)&0x0020)==0); 
N	}
N}
N
N/*-------------------------------------------------------------------------
N**  Function Name		: unpack_uartdata(Uint8* datapack)
N**  Description 		: unpacks the config data or request received from MSP and executes the command
N**  Intput parameters   : datapack pointer
N**  Output parameters	: None
N** 	Returns				: void
N**-------------------------------------------------------------------------*/
Nvoid unpack_uartdata(Uint8* datapack)
...
X{	unsigned char datapack_MSP[4]={0};
N	Uint8 no_of_datapoints=4;
X	unsigned char no_of_datapoints=4;
N	switch(datapack[1])
N	{
N	case Power_set_cmd:
X	case 0x01:
N
N		Power_peripherals(datapack[2]);
N
N		break;
N	case Mode_NIBPMode_ECGConfig_NotchFilterFrequency_set_cmd:
X	case 0x02:
N
N
N
N		break;
N	case Diagnostics_status_request:
X	case 0x04:
N		pack_to_MSP(Diagnostics_StsRegister,Diagnostics_status_request,datapack_MSP);
X		pack_to_MSP(Diagnostics_StsRegister,0x04,datapack_MSP);
N		send_via_uart(no_of_datapoints,datapack_MSP);
N		break;
N	case Flags_Status_request:
X	case 0x05:
N		pack_to_MSP(Flag_StsRegister,Flags_Status_request,datapack_MSP);
X		pack_to_MSP(Flag_StsRegister,0x05,datapack_MSP);
N		send_via_uart(no_of_datapoints,datapack_MSP);
N		break;
N	case Respiration_rate_request:
X	case 0x06:
N		pack_to_MSP(Respiration_Rate,Respiration_rate_request,datapack_MSP);
X		pack_to_MSP(Respiration_Rate,0x06,datapack_MSP);
N		send_via_uart(no_of_datapoints,datapack_MSP);
N		break;
N	case Blood_oxygen_percentage_request:
X	case 0x07:
N		pack_to_MSP(SPO2_Percentage,Blood_oxygen_percentage_request,datapack_MSP);
X		pack_to_MSP(SPO2_Percentage,0x07,datapack_MSP);
N		send_via_uart(no_of_datapoints,datapack_MSP);
N		break;
N	case Heart_rate_request:
X	case 0x08:
N		pack_to_MSP(Heart_Rate,Heart_rate_request,datapack_MSP);
X		pack_to_MSP(Heart_Rate,0x08,datapack_MSP);
N		send_via_uart(no_of_datapoints,datapack_MSP);
N		break;
N	default:
N		break;
...
N
N/*-------------------------------------------------------------------------
N**  Function Name		: Power_peripherals(uint8_t power_command)
N**  Description 		: to switch on/off peripherals o receiveing the power set command
N**  Intput parameters   : power_command
N**  Output parameters	: None
N** 	Returns				: void
N**-------------------------------------------------------------------------*/
Nvoid Mode_NIBPModeECGgain_NotchFreq(Uint8 Mode_NIBPmodeECGgainNotch)
...
N{
N
N	Uint8 mask=(Uint8)0x01;
X	unsigned char mask=(unsigned char)0x01;
N	Uint8 i;
X	unsigned char i;
N	for(i=0;i<5;i++)
N	{	switch(i)
...
N
N			case (Uint8)0:
X			case (unsigned char)0:
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N
N						/*normal mode of operation */
N						Normal_Mode=(Uint8)1;
X						Normal_Mode=(unsigned char)1;
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(Uint8)Normal_0_Calibration_1_Mode;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(unsigned char)0x01;
N
N					}
N					else
N					{
N						/*calibration mode of operation*/
N						Normal_Mode=(Uint8)0;
X						Normal_Mode=(unsigned char)0;
N
N						//to place code to be executed when set to calobration mode
N
N
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(Uint8)Normal_0_Calibration_1_Mode;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(unsigned char)0x01;
...
N
N			case (Uint8)1:
X			case (unsigned char)1:
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N						/*patient changed ,need to reset patient specific settings */
N						Patient_change=(Uint8)1;
X						Patient_change=(unsigned char)1;
N
N						//to place code to be executed when patient is changed
N
N
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(Uint8)Patient_change_Yes_1_No_0;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(unsigned char)0x02;
N
N					}
N					else
N
...
N
N						/**/
N						Patient_change=(Uint8)0;
X						Patient_change=(unsigned char)0;
N
N
N
N
...
N			break;
N			case (Uint8)2:
X			case (unsigned char)2:
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N					/*pediatric mode of operation*/
N						NIBP_Pediatric_Mode=(Uint8)1;
X						NIBP_Pediatric_Mode=(unsigned char)1;
N
N						//to place code to be executed when pediatric mode is selected for BP measurement
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(Uint8)NIBP_Pediatric_1_Adult_0_Mode;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(unsigned char)0x04;
N					}
N						/*adult mode of operation*/
N					else
N					{
N						NIBP_Pediatric_Mode=(Uint8)0;
X						NIBP_Pediatric_Mode=(unsigned char)0;
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(Uint8)NIBP_Pediatric_1_Adult_0_Mode;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(unsigned char)0x04;
N
N
N					}
N			break;
N			case (Uint8)3:/*ECG gain*/
X			case (unsigned char)3: 
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N					/*to set ECG gain */
...
N					}
N			break;
N			case (Uint8)4:/*ECG_gain*/
X			case (unsigned char)4: 
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N
...
N						ECG_gain_bit1=0;
N					}
N					if((ECG_gain_bit0==0)&&(ECG_gain_bit1==0))
N					{
N						ECG_gain=1;
N						Set_ECG_gain(6);
N
N					}
N					if((ECG_gain_bit0==0)&&(ECG_gain_bit1==1))
N					{
N						ECG_gain=4;
N						Set_ECG_gain(4);
N					}
N					if((ECG_gain_bit0==1)&&(ECG_gain_bit1==1))
N					{
N						ECG_gain=8;
N						Set_ECG_gain(5);
N					}
...
N			break;
N			case (Uint8)5:
X			case (unsigned char)5:
N					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(Uint8)1)
X					if(((mask<<i)&Mode_NIBPmodeECGgainNotch)==(unsigned char)1)
N					{
N					/*notch frequency is 60 Hz */
N						Notch_Filter_60_Hz=(Uint8)1;
X						Notch_Filter_60_Hz=(unsigned char)1;
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(Uint8)Notch_Filter_50hz_0_60hz_1;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister|=(unsigned char)0x20;
N
N					}
N					else
N					{/*notch frequency is 50Hz*/
N						/*to stop temperature read*/
N						Notch_Filter_60_Hz=(Uint8)0;
X						Notch_Filter_60_Hz=(unsigned char)0;
N						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(Uint8)Notch_Filter_50hz_0_60hz_1;
X						ModeNIBPmode_ECGConfig_Notchfreq_Config_StsRegister&=~(unsigned char)0x20;
N					}
N			break;
...
N	Uint8 i;
X	unsigned char i;
N	for(i=(Uint8)0;i<(Uint8)5;i++)
X	for(i=(unsigned char)0;i<(unsigned char)5;i++)
N	{	switch(i)
N		{
N
N
...
N			case (Uint8)0:
X			case (unsigned char)0:
N					if(((mask<<i)&power_command)==(Uint8)ECG_Power)
X					if(((mask<<i)&power_command)==(unsigned char)0x01)
N					{
N						/*to power ON ECG */
N
N//						 *GPIO_DOUT0_ADDR = *GPIO_DOUT0_ADDR | 0x0400;
N						 Power_Config_StsRegister|=(Uint8)ECG_Power;
X						 Power_Config_StsRegister|=(unsigned char)0x01;
N
N					}
N					else
N					{	/*to power OFF ECG*/
...
N			case (Uint8)1:
X			case (unsigned char)1:
N					if(((mask<<i)&power_command)==(Uint8)SpO2_Power)
X					if(((mask<<i)&power_command)==(unsigned char)0x02)
N					{
N					/*to power ON SPO2 */
N
N//						*GPIO_DOUT0_ADDR = *GPIO_DOUT0_ADDR | 0x8000;
N						Power_Config_StsRegister|=(Uint8)SpO2_Power;
X						Power_Config_StsRegister|=(unsigned char)0x02;
N					}
N					/*to power OFF SPO2*/
N
N					else
N					{
N//						*GPIO_DOUT0_ADDR = *GPIO_DOUT0_ADDR & 0x7FFF;
N						Power_Config_StsRegister&=~(Uint8)SpO2_Power;
X						Power_Config_StsRegister&=~(unsigned char)0x02;
N					}
N
...
N
N
NUint8 Set_ECG_gain(Uint16 ecg_gain_setting)
Xunsigned char Set_ECG_gain(unsigned short ecg_gain_setting)
N{
N	 PSP_Result Status = 0;
N	 Uint32 SPIBuf[32] = {0};
X	 unsigned long SPIBuf[32] = {0};
N	 Uint16 wLen = 0;
X	 unsigned short wLen = 0;
N	 Uint16 fLen = 0;
X	 unsigned short fLen = 0;
N	 Uint32 Command[2] = {0};
X	 unsigned long Command[2] = {0};
N	 Uint16 comWLen = 0;
X	 unsigned short comWLen = 0;
N	 Uint16 comFLen = 0;
X	 unsigned short comFLen = 0;
N	 Uint32 ADS1298RegVal_gain_set[8]={0};
X	 unsigned long ADS1298RegVal_gain_set[8]={0};
N
N
N	/* Stop read continuous mode command */
N	SPIBuf[0] = CMD_SDATAC;			/* SPI Tx Buffer*/
X	SPIBuf[0] = 0x11;			 
N	wLen = 8;                        /*No. of bits per word to be transmitted*/
N	fLen = 2;
N
N	/*Sending the SDATAC command to ADS1298 in order to write into registers*/
...
N
N
N	 /*Register write command for 6 registers from address 05h*/
N	 wLen = 8;                        /*No. of bits per word to be transmitted*/
N     fLen = 28;
N
N     ADS1298RegVal_gain_set[0]=0x45;
N     ADS1298RegVal_gain_set[1]=0x05;
N     ADS1298RegVal_gain_set[2]=ecg_gain_setting;
N     ADS1298RegVal_gain_set[3]=ecg_gain_setting;
N     ADS1298RegVal_gain_set[4]=ecg_gain_setting;
N     ADS1298RegVal_gain_set[5]=ecg_gain_setting;
N     ADS1298RegVal_gain_set[6]=ecg_gain_setting;
N     ADS1298RegVal_gain_set[7]=ecg_gain_setting;
N
N
N	 /*Sending write register command and data to ADS1298*/
N    Status = LLC_SPI_WordLengthWrite( ADS1298RegVal_gain_set, wLen, fLen);
N    if(Status != PSP_SOK)
X    if(Status != (0))
N	 {
N       return (Status);
...
N	SPIBuf[0] = CMD_RDATAC;			/* SPI Tx Buffer*/
X	SPIBuf[0] = 0x10;			 
N	wLen = 8;                        /*No. of bits per word to be transmitted*/
N	fLen = 2;
N
...
N 	 return Status;
N
W "../src/Communication_protocol.c" 468 10 variable "Command" was declared but never referenced
W "../src/Communication_protocol.c" 469 10 variable "comWLen" was declared but never referenced
W "../src/Communication_protocol.c" 470 10 variable "comFLen" was declared but never referenced
N}
N
N
N
